...
**Maximum 4 annotation/uplift agents at a time.** Running more burns through API
capacity too fast and causes agents to hit rate limits mid-work, leaving files
partially annotated. Launch a batch of 4, wait for completion, then launch the next.
