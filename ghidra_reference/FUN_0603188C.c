/* FUN_0603188C  0x0603188C */


int FUN_0603188c(undefined4 param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  sVar4 = (*(code *)PTR_FUN_060318e8)(unaff_r8 - param_3,unaff_r9 - param_4);
  iVar8 = (int)-sVar4;
  ...
  if (0 < (int)uVar5) {
    ...
    in_r0 = (*DAT_06031a1c)(-(int)puVar9);
    unaff_r13[4] = uVar7 + ((int)((ulonglong)((longlong)extraout_r3_00 * (longlong)in_r0) >> 0x20)
                            << 0x10 | (uint)((longlong)extraout_r3_00 * (longlong)in_r0) >> 0x10);
