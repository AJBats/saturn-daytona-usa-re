/* FUN_06030FFC  0x06030FFC */


/* WARNING: Type propagation algorithm not settling */

int FUN_06030ffc(void)

{
  ...
  sVar4 = (*in_r0)();
  iVar11 = (int)-sVar4;
  sVar4 = (*(code *)PTR_FUN_060310bc)
                    (unaff_r13[0xe] - unaff_r14[0xe],unaff_r13[0xf] - unaff_r14[0xf],unaff_r14[0xe],
                     unaff_r14[0xf],in_pr);
  ...
  bVar1 = uVar10 != uVar5;
  uVar13 = (*DAT_060310c0)(iVar6);
  iVar6 = (int)uVar13;
  uVar5 = extraout_r2 - iVar11 & 0xffff;
  if ((int)uVar7 <= (int)uVar5) {
    uVar5 = uVar5 - uVar7;
  }
  uVar7 = (uint)((ulonglong)uVar13 >> 0x29);
  iVar9 = 0;
  ...
  if (((bVar1) && (uVar10 = (uint)(uVar10 == 0), iVar9 != 0)) ||
    ...
    if (((int)DAT_0603112e < (int)uVar5) && ((int)uVar5 < DAT_0603112e * 3)) {
      ...
      if ((iVar9 == 0) && ((int)((uint)puVar12 >> 1) <= (int)(unaff_r14[3] - unaff_r13[3]))) {
        puVar12 = PTR_DAT_06031198;
        if (uVar10 != 0) {
          puVar12 = (undefined *)((uint)PTR_DAT_06031198 >> 1);
        }
        *unaff_r14 = *unaff_r14 | (uint)puVar12;
      }
      else {
        uVar5 = unaff_r14[10] - iVar11 & 0xffff;
    ...
    if (iVar9 == 0) {
      ...
      *unaff_r14 = *unaff_r14 | uVar5;
      ...
      iVar11 = (int)DAT_0603129e;
      if (uVar10 == 0) {
        iVar11 = iVar11 * 3;
      }
      iVar11 = (unaff_r14[0xc] & 0xffff) + iVar11;
      unaff_r12 = (undefined *)
    ...
    if (*(short *)((int)PTR_DAT_060312a0._0_2_ + (int)unaff_r14) < 8) {
      if (*(short *)((int)PTR_DAT_060312a0._0_2_ + (int)unaff_r14) < 6) {
        ...
        puVar12 = puStack00000000 + ((uint)unaff_r12 >> 1);
      }
      else {
    ...
    unaff_r13[0xe] = uVar5;
    unaff_r13[0xf] = uVar7;
    iVar6 = (*(code *)PTR_FUN_06031334)(-iVar11);
    iVar9 = (*DAT_06031338)(-iVar11);
    ...
    unaff_r13[6] = uVar7 + ((int)((ulonglong)((longlong)(int)puVar12 * (longlong)iVar6) >> 0x20) <<
                            0x10 | (uint)((longlong)(int)puVar12 * (longlong)iVar6) >> 0x10);
    puVar12 = PTR_DAT_0603133c + iVar11;
    uVar5 = unaff_r14[4];
    uVar7 = unaff_r14[6];
    unaff_r14[0xe] = uVar5;
    unaff_r14[0xf] = uVar7;
    iVar11 = (*(code *)PTR_FUN_06031334)(-(int)puVar12);
    iVar6 = (*DAT_06031338)(-(int)puVar12);
    ...
    unaff_r14[6] = uVar7 + ((int)((ulonglong)((longlong)(int)puStack00000000 * (longlong)iVar11) >>
                                 0x20) << 0x10 |
                           (uint)((longlong)(int)puStack00000000 * (longlong)iVar11) >> 0x10);
  }
  return iVar6;
}
