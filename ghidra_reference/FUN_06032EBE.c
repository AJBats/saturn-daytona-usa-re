/* FUN_06032EBE  0x06032EBE */


undefined4 FUN_06032ebe(void)

{
  ...
  (*(code *)PTR_FUN_06032ff8)
            (*(undefined4 *)(unaff_r14 + DAT_06032fec),*(undefined4 *)(unaff_r14 + DAT_06032ff0),
             *(undefined4 *)(unaff_r14 + DAT_06032ff4),in_r7,in_pr);
  (*(code *)PTR_FUN_06033000)((int)*(short *)(unaff_r14 + DAT_06032ffc));
