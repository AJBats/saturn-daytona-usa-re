...

{
  ...
  *(undefined **)(&stack0xffffffe4 + iVar3) = PTR_DAT_06023748;
  ...
  do {
    ...
    iVar4 = *(int *)(&stack0xffffffe8 + (short)(uVar8 * 0xc) + iVar3);
    *(undefined2 *)((int)auStack_20 + iVar3) =
         *(undefined2 *)((int)(&stack0xffffffe8 + (short)(uVar8 * 0xc) + iVar3) + 8);
    uVar7 = 0;
    if (*(short *)((int)auStack_20 + iVar3) != 0) {
      do {
        if (iVar4 == 0) break;
        if (uVar8 == 0x1d) {
          if (uVar7 == 0x17) {
        ...
        (*(code *)PTR_FUN_0602381c)(iVar4,sVar6,*(undefined4 *)(&stack0xffffffe4 + iVar3));
        uVar7 = uVar7 + 1;
        iVar4 = iVar4 + 0xc;
      } while (uVar7 < *(ushort *)((int)auStack_20 + iVar3));
    }
    iVar4 = (short)(uVar8 * 0xc) + iVar3;
    iVar5 = *(int *)(&stack0xffffffec + iVar4);
    *(undefined2 *)((int)auStack_20 + iVar3) = *(undefined2 *)(&stack0xfffffff2 + iVar4);
    if (0x1c < uVar8) {
