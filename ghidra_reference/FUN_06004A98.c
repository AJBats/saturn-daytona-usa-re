...
void FUN_06004a98()
{
  ...
  *(short *)0x06086028 = (short)0x00008000;
  ...
  (*(int(*)())0x06036E90)(0x25F00FFE,1,puVar5);
  ...
  *(int *)puVar3 = 2;
  ...
  (*(int(*)())(*(int *)0x06000300))(0x40,0x06006F3C);

  (*(int(*)())(*(int *)0x06000300))(0x41,0x06007268);

  (*(int(*)())0x0603950C)(2,2,0x10,5,0x06063DA8,0);
  ...
  *(char **)0x060612AC = puVar3;
  ...
  (*(int(*)())puVar2)(4,&local_7c);

  *(short *)0x060A3DB8 = (short)0x0000C024;

  (*(int(*)())0x0603850C)(4);

  (*(int(*)())0x06038794)(0x00010000);
  ...
  *(char **)0x060612B0 = puVar3;
  ...
  (*(int(*)())puVar2)(8,&local_7c);

  *(short *)0x060A3DBA = (short)0x0000C044;

  (*(int(*)())0x0603850C)(8);

  (*(int(*)())0x0603806C)(0x06087C84);
  ...
  *(char **)(puVar4 + 0xc) = 0x25E5FF00;
  ...
  for (uVar6 = 0; uVar6 < (unsigned int)0x100; uVar6 = uVar6 + 8) {
  ...
  *(char **)0x060612B8 = puVar3;
  ...
  (*(int(*)())puVar2)(0x20,&local_7c);

  *(short *)0x060A3DBE = (short)0x0000C060;

  (*(int(*)())0x060370C0)(auStack_30);
  ...
  (*(int(*)())0x060370E4)(auStack_30);

  (*(int(*)())0x06038044)(0x06059F20);

  (*(int(*)())0x060148FC)();

  (*(int(*)())0x060149E0)();

  (*(int(*)())(*(int *)puVar1))(-132,0);

  (*(int(*)())0x06026CE0)();

  (*(int(*)())(*(int *)puVar1))(0xffffffff,0x83);
