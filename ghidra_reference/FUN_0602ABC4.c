/* FUN_0602ABC4  0x0602ABC4 */


uint FUN_0602abc4(int param_1,undefined4 param_2,undefined1 param_3,int param_4)

{
  ...
  iVar8 = 0x40;
  puVar17 = (undefined4 *)PTR_DAT_0602ac04;
  do {
    *puVar17 = 0xffffffff;
    iVar8 = iVar8 + -1;
  ...
  do {
    puVar4 = PTR_DAT_0602ac80;
    puVar16 = puVar15 + -6;
    uVar21 = in_sr & 0xfffffffe;
    uVar20 = uVar21 | *(short *)PTR_DAT_0602ac0c == 0;
    if ((((byte)uVar20 & 1) == 1) ||
       (uVar6 = (uint)*(short *)((int)puVar15 + -10), uVar20 = uVar21,
       (int)PTR_DAT_0602ac00._0_2_ != uVar6)) {
      puVar12 = *(uint **)PTR_DAT_0602ac88;
      puVar10 = (uint *)PTR_DAT_0602ac84;
      FUN_0602ae24(puVar9);
      *puVar10 = extraout_r1;
      puVar10[1] = extraout_r2;
      puVar10[2] = extraout_r3;
      puVar5 = PTR_DAT_0602ac8c;
      ...
      if ((puVar15[-3] & 0x80000) == 0) {
        ...
        *(uint *)PTR_DAT_0602ac8c = uVar6 << 0x10 | uVar25 >> 0x10;
        uVar3 = puVar12[4];
        uVar6 = puVar15[-5];
        uVar1 = uVar3 ^ uVar6;
        if ((int)uVar3 < 0) {
        ...
        *(uint *)(puVar5 + 8) = uVar6 << 0x10 | uVar25 >> 0x10;
        ...
        if (((byte)uVar21 & 1) != 1) goto LAB_0602adf8;
      }
      FUN_0602aebe();
      ...
      *puVar10 = extraout_r3_03;
      FUN_0602ae84();
      puVar5 = PTR_DAT_0602ad18;
      uVar20 = *(uint *)PTR_DAT_0602ad14 & 0xffff;
      ...
      if ((((iVar18 <= (int)uVar6) || (iVar18 <= iVar8)) || (iVar18 <= (int)puVar9)) ||
        ...
        if (((((byte)uVar22 & 1) == 1) ||
          ...
          if (((iVar19 <= iVar18) || (iVar19 <= iVar7)) ||
            ...
            {
              *(short *)(PTR_DAT_0602ad18 + uVar20 * 0x18 + 0x16) = (short)iVar14;
              ...
              *(undefined2 *)(puVar5 + uVar20 * 0x18 + 6) = *(undefined2 *)((int)puVar15 + -10);
              ...
              puVar5[uVar20 * 0x18 + 5] = param_3;
                    /* WARNING: Could not recover jumptable at 0x0602ad92. Too many branches */
                    /* WARNING: Treating indirect jump as call */
              uVar21 = (**(code **)(PTR_LAB_0602ad9c + ((int)*(short *)(puVar15 + -3) & 7U) * 4))
