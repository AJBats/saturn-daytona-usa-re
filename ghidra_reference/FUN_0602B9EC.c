/* FUN_0602B9EC  0x0602B9EC */


uint FUN_0602b9ec(int param_1,undefined4 param_2,undefined1 param_3,int param_4)

{
  ...
  iVar7 = 0x40;
  puVar16 = (undefined4 *)PTR_DAT_0602ba88;
  do {
    *puVar16 = 0xffffffff;
    iVar7 = iVar7 + -1;
  ...
  do {
    puVar3 = PTR_DAT_0602ba90;
    puVar15 = puVar14 + -6;
    puVar11 = *(uint **)PTR_DAT_0602ba98;
    puVar9 = (uint *)PTR_DAT_0602ba94;
    FUN_0602bc7a(*(undefined2 *)(puVar14 + -2));
    *puVar9 = extraout_r1;
    puVar9[1] = extraout_r2;
    puVar9[2] = extraout_r3;
    *(uint *)PTR_DAT_0602ba9c = extraout_r2;
    puVar4 = PTR_DAT_0602baa0;
    ...
    if ((puVar14[-3] & 0x80000) == 0) {
      ...
      *(uint *)PTR_DAT_0602baa0 = uVar5 << 0x10 | uVar24 >> 0x10;
      uVar20 = puVar11[4];
      uVar5 = puVar14[-5];
      uVar1 = uVar20 ^ uVar5;
      if ((int)uVar20 < 0) {
      ...
      *(uint *)(puVar4 + 8) = uVar5 << 0x10 | uVar24 >> 0x10;
      ...
      if (((byte)uVar19 & 1) == 1) goto LAB_0602baa4;
    }
    else {
LAB_0602baa4:
      ...
      *puVar9 = extraout_r3_03;
      FUN_0602bcfc();
      puVar4 = PTR_DAT_0602bb3c;
      uVar21 = *(uint *)PTR_DAT_0602bb38 & 0xffff;
      ...
      if ((((iVar17 <= (int)uVar5) || (iVar17 <= iVar7)) || (iVar17 <= iVar8)) || (iVar17 <= iVar12)
        ...
        if (((((byte)uVar20 & 1) == 1) ||
          ...
          if (((iVar18 <= iVar17) || (iVar18 <= iVar6)) ||
            ...
            {
              *(short *)(PTR_DAT_0602bb3c + uVar21 * 0x18 + 0x16) = (short)iVar13;
              ...
              *(undefined2 *)(puVar4 + uVar21 * 0x18 + 6) = *(undefined2 *)((int)puVar14 + -10);
              ...
              puVar4[uVar21 * 0x18 + 5] = param_3;
                    /* WARNING: Could not recover jumptable at 0x0602bbb6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
              uVar19 = (**(code **)(PTR_LAB_0602bbc0 + ((int)*(short *)(puVar14 + -3) & 7U) * 4))
