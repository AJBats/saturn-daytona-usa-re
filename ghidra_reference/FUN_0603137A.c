/* FUN_0603137A  0x0603137A */


/* WARNING: Type propagation algorithm not settling */

int FUN_0603137a(void)

{
  ...
  sVar6 = (*in_r0)();
  iVar13 = (int)-sVar6;
  sVar6 = (*(code *)PTR_FUN_0603143c)
                    (unaff_r14[0xe] - unaff_r13[0xe],unaff_r14[0xf] - unaff_r13[0xf],unaff_r13[0xe],
                     unaff_r13[0xf],in_pr);
  ...
  bVar2 = uVar12 != uVar7;
  uVar15 = (*DAT_06031440)(iVar8);
  iVar8 = (int)uVar15;
  uVar7 = extraout_r2 - iVar13 & 0xffff;
  ...
  if (((bVar2) && (uVar12 = (uint)(uVar12 == 0), iVar11 != 0)) ||
    ...
    if (((int)DAT_06031496 < (int)uVar7) && ((int)uVar7 < DAT_06031496 * 3)) {
      ...
      if ((int)PTR_DAT_060314c8 < (int)(unaff_r13[3] - unaff_r14[3])) {
        *unaff_r13 = *unaff_r13 | DAT_060314cc;
        ...
        puVar14 = PTR_DAT_060314f8;
        if (uVar12 != 0) {
          puVar14 = (undefined *)((uint)PTR_DAT_060314f8 >> 1);
        }
        *unaff_r13 = *unaff_r13 | (uint)puVar14;
      }
      else {
        uVar7 = unaff_r13[10] - iVar13 & 0xffff;
    ...
    if (iVar11 == 0) {
      ...
      *unaff_r14 = *unaff_r14 | uVar7;
      ...
      iVar13 = (int)DAT_0603162c;
      if (uVar12 == 0) {
        iVar13 = iVar13 * 3;
      }
      iVar13 = (unaff_r13[0xc] & 0xffff) + iVar13;
      unaff_r12 = (undefined *)
    ...
    if (*(short *)((int)DAT_0603162e + (int)unaff_r14) < 8) {
      if (*(short *)((int)DAT_0603162e + (int)unaff_r14) < 6) {
        ...
        puVar14 = (undefined *)((uint)unaff_r12 >> 2);
      }
      else {
    ...
    unaff_r14[0xe] = uVar7;
    unaff_r14[0xf] = uVar9;
    iVar8 = (*(code *)PTR_FUN_060316b8)(-iVar13);
    iVar11 = (*DAT_060316bc)(-iVar13);
    ...
    unaff_r14[6] = uVar9 + ((int)((ulonglong)((longlong)(int)puVar14 * (longlong)iVar8) >> 0x20) <<
                            0x10 | (uint)((longlong)(int)puVar14 * (longlong)iVar8) >> 0x10);
    puVar14 = PTR_DAT_060316c0 + iVar13;
    uVar7 = unaff_r13[4];
    uVar9 = unaff_r13[6];
    unaff_r13[0xe] = uVar7;
    unaff_r13[0xf] = uVar9;
    iVar13 = (*(code *)PTR_FUN_060316b8)(-(int)puVar14);
    iVar8 = (*DAT_060316bc)(-(int)puVar14);
