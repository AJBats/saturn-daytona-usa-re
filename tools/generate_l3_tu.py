...
Defaults:
    --input  reimpl/retail/game_update_loop.s
    --output reimpl/src/game_update_loop.s
"""
...
# Constants
# ---------------------------------------------------------------------------
TU_START = 0x06033BC8  # inclusive
TU_END   = 0x06034E20  # exclusive
...
def generate_output(image, code_addrs, globals_map, fourbyte_map,
    ...
    # Header
    lines.append("/* game_update_loop -- L3 assembly (SH-2 mnemonics)")
...
def main():
    ...
    parser.add_argument('--input', '-i',
                        default='reimpl/retail/game_update_loop.s',
                        help='Input retail .s file')
    parser.add_argument('--output', '-o',
                        default='reimpl/src/game_update_loop.s',
