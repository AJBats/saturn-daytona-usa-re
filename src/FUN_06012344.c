...
void FUN_06012344()
{
  ...
  iVar1 = (*(int(*)())0x06027552)(iVar4,(int)DAT_060123de);

  iVar2 = (*(int(*)())puVar3)(iVar4,(int)DAT_060123e0);

  iVar4 = (*(int(*)())puVar3)(iVar4,(int)DAT_060123e2);
  ...
  *(int *)0x060788D8 = *(int *)0x060788D8 + (iVar1 << 1);
