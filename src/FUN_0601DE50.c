...
int FUN_0601de50()
{
  ...
  if (*(unsigned int *)(0x06078900 + DAT_0601df18) < *(unsigned int *)0x06086008 &&
    ...
    *(int *)
    ...
    (*puVar2)(8,*puVar6,(int)DAT_0601df1e,0x0000A000 + puVar6[1]);
    ...
    *0x0605DFEC = *0x0605DFEC + '@';
    ...
    if ((char)*puVar4 < '\0') {
      ...
      uVar5 = (*0x060283E0)(8,(int)DAT_0601df7a,0x0000E000,0x0605ACE3);
    ...
    uVar5 = (*puVar2)(8,0x0605DFF4,(int)PTR_DAT_0601df20,
