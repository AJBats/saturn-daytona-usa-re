...
char * FUN_0602db00()
{
  ...
  (*0x0601D5F4)(0x00000002,0x00000000);

  (*0x0601D5F4)(0x00000003,0x00000000);

  uVar4 = 0x00000000;

  *(int *)0x06082A30 = 0x00000000;

  *0x06082A26 = (char)uVar4;
  ...
  *(int *)(0x000000C0 + iVar2) = 0x00000000;
  ...
  (*0x0602E450)(*(int *)((int)DAT_0602e372 + *(int *)0x0607E940));

  (*0x0602E4BC)();

  (*0x0600CE66)();

  (*0x0603053C)(0x00000000);

  (*0x0600D780)(0x00000000);
  ...
  *(int *)(puVar3 + DAT_0602e376) = *(int *)(puVar3 + 0x00300020);
  ...
  if (0x00000028 <= *(int *)0x06082A2C) {
    ...
    if (((int)(char)*0x06082A25 & 0x00000004) == 0) {
      ...
      puVar3 = (char *)(*0x0603226C)();

    }

    else {

      *0x06082A26 = (char)0x00000000;
