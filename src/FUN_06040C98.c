    ...
    int param_2;
{
  ...
  *(int *)0x060A5400 = param_1;
  ...
  if ((bVar8 != 9) && (bVar8 != 10)) {
    ...
    iVar5 = (*0x06034B9A)(iVar11,0x0000FFFF,iVar11,iVar11);
    ...
    (*0x06034B54)(0,local_30);

    (*0x06034B54)(local_30[0],local_30);
    ...
    (*0x060364D4)((int)DAT_06040e72,iVar11);
