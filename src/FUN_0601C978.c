...
void FUN_0601c978()
{
  ...
  *(int *)0x06086024 = 0;
  ...
  (*(void(*)())0x0602766C)(0x25F00000,0x0604880C,0x40);

  (*(void(*)())0x0600511E)(0x25E70E40,0x00014000,0,9);

  (*(void(*)())0x0600511E)(0x25E7B168,0x00016BC0,0,9);

  (*(void(*)())0x06028400)(4,*(int *)0x06063958,(int)DAT_0601ca3e,

             *(int *)(0x06063958 + 4),0x06063958);

  (*(void(*)())0x06028400)(0,*(int *)0x06063960,(int)DAT_0601ca3e,

             *(int *)(0x06063960 + 4),0x06063960);

  puVar1 = 0x06038BD4;

  (*(void(*)())0x06038BD4)((int)PTR_DAT_0601ca40,0);
  ...
  (*(void(*)())0x06036E90)(0x25F00FFE,1,0x06086028);
