...
void FUN_0600afb2()
{
  ...
  *(int *)0x0607E940 = iVar4;
  ...
  (*0x060271A2)(0x00008000 + *(int *)(iVar4 + 0x20));

  (*0x060271EE)(-*(int *)(iVar4 + 0x24));
  ...
  (*0x060271A2)
            ...
            (*(int *)(iVar4 + DAT_0600b100) + *(int *)(iVar4 + DAT_0600b100 + -0xc));

  if (*(int *)0x06059F30 != 0) {

    (*0x06032158)(*(int *)0x0606213C,*(int *)0x060621E8);

    (*0x06031DF4)

              (*(int *)0x060620E8,*(short *)0x06089E44,

               *(int *)0x06062190);

    (*0x060270F2)(0,*(int *)(iVar4 + DAT_0600b102));

    (*0x060271EE)(*(int *)(iVar4 + DAT_0600b104));

    (*puVar2)(*(int *)(iVar4 + DAT_0600b106));
    ...
    (*0x06032158)
              ...
              (*(int *)(0x0606212C + iVar3),*(int *)(0x060621D8 + iVar3));

    (*0x06031DF4)

              (*(int *)(0x060620D8 + iVar3),*(short *)0x06089E44,
