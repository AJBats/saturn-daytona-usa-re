...
void FUN_06005788()
{
  ...
  (*(void(*)())0x06028400)(8,*(int *)(0x06063750 + 0x20),0x80,
  ...
  if (*puVar1 != '\0') {
    ...
    (*(void(*)())0x060284AE)(8,(int)DAT_06005852,0x60,0x0605ACDF);
  ...
  if ((*(unsigned int *)0x0607EAB8 & 1) == 0) {
    ...
    (*(void(*)())0x06028400)(8,*(int *)(puVar2 + 0x28),(iVar10 * 0x40 + 0x19) * 2,
  ...
  if (*(unsigned int *)0x06063F28 < 10) {
    ...
    (*(void(*)())0x06028430)(8,(int)PTR_DAT_06005854,0,*(int *)0x06063F28);

  }

  else {

    (*(void(*)())0x06028430)(8,(int)DAT_0600590c,0xc,*(int *)0x06063F28);

  }

  if (*(int *)0x0607EAE0 == 0) {

    (*(void(*)())0x06028430)(8,(int)DAT_0600590e,0x30,*(int *)0x0607EA98);
  ...
  if (*(int *)0x06078644 == 0) {
    ...
    (*(void(*)())0x06028400)(8,*(int *)(puVar2 + 0x30),(iVar10 * 0x40 + 0x16) * 2,
