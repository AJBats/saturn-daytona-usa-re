...
LAB_0602b600:
      ...
      *(short *)(puVar7 + 6) = 0;
      ...
      if (iVar8 != 4) {
        ...
        (*(void(*)())(*(int *)(0x0602B9AC + iVar8 * 4)))(0x06094A30,0x06094A28,param_3 + 6,param_4 + 2);
