...
int FUN_060173ac()
{
  ...
  iVar11 = (*(void(*)())0x06034FE0)(*(int *)(puVar2 + DAT_060175b6) + 1,10);

  iVar3 = (*(void(*)())0x06035C2C)();

  if (*(int *)0x0607EAE0 == 0) {

    iVar12 = (int)DAT_06017692;

    iVar14 = (int)DAT_06017694;
    ...
    if (iVar11 != 0) {
      ...
      FUN_06017784(*(int *)(puVar1 + (iVar11 + 0x5f) * 8),

                   *(int *)(puVar1 + DAT_0601772a) + (int)DAT_0601772c,puVar15[0xf],puVar15[0x10]);

    }

    uVar4 = FUN_06017784(*(int *)(puVar1 + (iVar3 + 0x5f) * 8),
