void FUN_060061c8()
{
  ...
  (*(int(*)())0x06026EDE)(*(int *)(iVar2 + 0x30));

  puVar1 = 0x06026FFC;

  (*(int(*)())0x06026FFC)(0x0604464C,0x06063E9C);

  (*(int(*)())puVar1)(0x06044640,0x06063EB0);

  (*(int(*)())puVar1)(0x06044658,0x06063ED8);

  (*(int(*)())puVar1)(0x06044664,0x06063EC4);
