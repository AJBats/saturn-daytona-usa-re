...
int FUN_0602e610()
{
  ...
  if (*(int *)0x06083268 == iVar10) {
    ...
    iVar4 = (*0x06027552)(iVar4,iVar4,iVar5);

    iVar2 = (*0x06027552)(iVar2 - iVar5,iVar2 - iVar5);

    uVar7 = iVar4 + iVar2;

    if ((int)uVar7 < 0) {

      iVar4 = (*0x06027476)(uVar7 >> 2);
  ...
  sVar1 = (*0x0602744C)
                    ...
                    (*(int *)(iVar10 + 0x10) - *(int *)(iVar9 + 0x10),
...
LAB_0602e864:
      ...
      if (iVar8 < 0x00000050) {
        ...
        (*0x0601D5F4)(0x00000000,0xAE1105FF,uVar6,iVar10,in_pr);

      }

      else {

        (*0x0601D5F4)(0x00000000,0xAE1109FF,uVar6,iVar10,in_pr);
  ...
  if (iVar8 < 0x00000050) {
    ...
    (*0x0601D5F4)(0x00000000,0xAE1106FF,uVar6,iVar10,in_pr);

  }

  else {

    (*0x0601D5F4)(0x00000000,0xAE110AFF,uVar6,iVar10,in_pr);
