    ...
    int *param_1;
{
  ...
  if ((uVar6 == 0) || (6 < uVar4)) {
    ...
    piVar2 = (int *)((uVar4 + *(int *)(iVar1 + PTR_DAT_0600cb88) * 8) * 0x10 +
    ...
    *param_1 = *piVar2;
    ...
    iVar1 = uVar4 + *(int *)(iVar1 + PTR_DAT_0600cb88) * 8;

    piVar2 = (int *)(iVar1 * 0x10 + *(int *)0x0607EB88);

    piVar5 = (int *)((iVar1 + 1) * 0x10 + *(int *)0x0607EB88);
