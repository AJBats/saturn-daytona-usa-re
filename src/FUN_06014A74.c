...
void FUN_06014a74()
{
  ...
  (*0x0602761E)(0x25F00660,0x06044A64,0x20);

  (*puVar2)(0x25F00680,0x06044A84,0x20);

  (*puVar2)(0x25F006A0,0x06044AA4,0x20);

  (*puVar2)(0x25F006C0,0x06044AC4,0x20);

  puVar3 = 0x25C00000;

  (*puVar2)(0x25C00000 + (int)DAT_06014bd0 + *(int *)0x06059FFC * 8,

                    0x06044AE4,0x20);

  (*puVar2)(puVar3 + (int)DAT_06014bd2 + *(int *)0x06059FFC * 8,0x06044B24,0x20)

  ;

  (*puVar2)(puVar3 + (int)DAT_06014bd4 + *(int *)0x06059FFC * 8,0x06044B04,0x20)

  ;

  (*puVar2)(puVar3 + (int)DAT_06014bd6 + *(int *)0x06059FFC * 8,0x06044B44,0x20)

  ;

  puVar2 = 0x0600511E;

  (*0x0600511E)(0x25E73B98,0x00017700,0,8);

  (*puVar2)(0x25E74158,0x000189E0,0,8);

  (*puVar2)(0x25E74AFC,0x0001AFA0,0,8);

  (*puVar2)(0x25E75730,0x0001C980,0,8);
