    ...
    int param_3;
{
  ...
  do {
    ...
    puVar22 = (unsigned int *)(int)DAT_06031e30;
    ...
    if (((unsigned char)uVar25 & 1) == 1) {
      ...
      puVar22[4] = (int)PTR_DAT_06031ea8;
      ...
      *(int *)(puVar3 + 4) =
      ...
      if (((unsigned char)uVar25 & 1) == 1) {
        ...
        *(int *)(puVar2 + 4) = extraout_r3;
        ...
        puVar22[4] = (int)PTR_DAT_06031f30;
        ...
        *(int *)(puVar11 + 0xc) =
        ...
        if (((unsigned char)uVar25 & 1) == 1) {
          ...
          *(int *)(puVar2 + 8) = extraout_r3_00;
          ...
          puVar22[4] = (int)PTR_DAT_06031f74;
