...
void FUN_06007a50()
{
  ...
  iVar8 = (*0x06027552)(iVar8,0x0000D1B7);
  ...
  (*0x06027358)(DAT_06007a96 + iVar8,&local_24,auStack_20);

  puVar3 = 0x06078604;

  puVar2 = 0x0602754C;

  iVar8 = (*puVar1)(0x00970000,local_24);

  sVar7 = (*puVar2)(-iVar8);

  *(short *)(puVar3 + 8) = sVar7 + 8;

  uVar5 = (*puVar1)(0x00970000,auStack_20[0]);
  ...
  *(short *)(puVar3 + 10) = sVar7 + sVar9;
  ...
  iVar8 = (*puVar1)(0x00020000,auStack_20[0]);

  iVar6 = (*puVar1)(puVar4,local_24);

  sVar7 = (*puVar2)(iVar8 - iVar6);

  *(short *)(puVar3 + 0xc) = sVar7 + 8;

  iVar8 = (*puVar1)(0x00020000,local_24);

  iVar6 = (*puVar1)(puVar4,auStack_20[0]);

  sVar7 = (*puVar2)(iVar8 + iVar6);

  *(short *)(puVar3 + 0xe) = sVar7 + sVar9;

  iVar8 = (*puVar1)(0x00890000,local_24);

  sVar7 = (*puVar2)(-iVar8);

  *(short *)(puVar3 + 0x10) = sVar7 + 8;

  uVar5 = (*puVar1)(0x00890000,auStack_20[0]);

  sVar7 = (*puVar2)(uVar5);

  *(short *)(puVar3 + 0x12) = sVar7 + sVar9;

  iVar8 = (*puVar1)(0xFFFE0000,auStack_20[0]);
  ...
  *(short *)(puVar3 + 0x14) = sVar7 + 8;
  ...
  iVar8 = (*puVar1)(0xFFFE0000,local_24);
  ...
  *(short *)(puVar3 + 6) = (short)0x0000A3FF;
  ...
  (*0x060280C4)(puVar3,*(int *)0x060785FC);
