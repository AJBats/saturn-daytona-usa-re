...
void FUN_06018a3c()
{
  ...
  if (*(int *)0x0605AD08 == 0) {
    ...
    (*(void(*)())0x06012DB4)(*(int *)puVar1);

    (**(void **)(0x0605D1BC + *(int *)puVar1 * 4))();

    (*(void(*)())0x06012D7C)(*(int *)puVar1);
  ...
  if ((*(unsigned int *)0x0607EBC4 & (int)DAT_06018b8e) == 0) {
    ...
    if (*(int *)0x0605AB18 == '\0') {
      ...
      if (*(int *)0x0605AD00 == 2) {
        ...
        (*(void(*)())0x06018E1E)((unsigned char)*0x06078648 + 6);
        ...
        (*(void(*)())0x06034D1C)(&local_30);

      }

      else {

        (*(void(*)())0x06018DDC)((unsigned char)*0x06078648 + 6,(unsigned char)*0x06078648 + 6,0xf);
    ...
    iVar5 = (int)(char)0x0605D23C[(unsigned char)*0x06078648];

  }

  (*(void(*)())0x06018DDC)(iVar5,iVar5,uVar6);
...
LAB_06018bd8:
  ...
  *(char **)0x06063F3C = 0x0604800C + *(int *)puVar1 * 8;

  iVar5 = (*(void(*)())0x06035280)();
  ...
  *(unsigned int *)puVar3 =
  ...
  (*(void(*)())0x0602761E)(0x25C00220 + *(int *)0x06059FFC * 8,0x0605CDDC,(int)DAT_06018cc6);
