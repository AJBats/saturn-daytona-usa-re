...
void FUN_06018a3c()
{
  ...
  if (*0x0605AD08 == 0) {
    ...
    (*0x06012DB4)(*(int *)puVar1);

    (**(void **)(0x0605D1BC + *(int *)puVar1 * 4))();

    (*0x06012D7C)(*(int *)puVar1);
  ...
  if ((*(unsigned int *)0x0607EBC4 & (int)DAT_06018b8e) == 0) {
    ...
    if (*0x0605AB18 == '\0') {
      ...
      if (*(int *)0x0605AD00 == 2) {
        ...
        (*0x06018E1E)((unsigned char)*0x06078648 + 6);
        ...
        (*0x06018DDC)((unsigned char)*0x06078648 + 6,(unsigned char)*0x06078648 + 6,0xf);
...
LAB_06018bd8:
  ...
  *(unsigned int *)puVar3 =
  ...
  (*0x0602761E)
            ...
            (0x25C00220 + *(int *)0x06059FFC * 8,0x0605CDDC,(int)DAT_06018cc6);
