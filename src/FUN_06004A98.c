...
void FUN_06004a98()
{
  ...
  (**(void **)0x06000344)(0xffffffff,(int)PTR_DAT_06004ac8);
  ...
  *(short *)0x06086028 = (short)0x00008000;
  ...
  (*0x06036E90)(0x25F00FFE,1,puVar5);
  ...
  *(int *)puVar3 = 2;
  ...
  (**(void **)0x06000300)(0x40,0x06006F3C);

  (**(void **)0x06000300)(0x41,0x06007268);

  (*0x0603950C)(2,2,0x10,5,0x06063DA8,0);
  ...
  *(char **)0x060612B8 = puVar3;
  ...
  (*puVar2)(0x20,&local_7c);

  *(short *)0x060A3DBE = (short)0x0000C060;

  (*0x060370C0)(auStack_30);
  ...
  (*0x060370E4)(auStack_30);

  (*0x06038044)(0x06059F20);
