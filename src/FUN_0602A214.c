...

    {
      ...
      *(unsigned short *)(puVar4 + 6) = (unsigned short)(iVar8 <= iVar17);
      ...
      if (((unsigned char)uVar19 & 1) != 1) {
        ...
        (**(void **)(0x0602A800 + iVar8 * 4))

                  (0x0608A7A0,0x0608A798,puVar14 + 9,puVar14 + 0xc);
        ...
        if ((((int)0xFFFFFF81 <= *(int *)(puVar5 + 4)) ||
          ...
          if (iVar9 != 4) {
            ...
            if (iVar9 != 0) {
              ...
              (**(void **)(0x0602A810 + iVar9 * 4))(puVar5,puVar6);
            ...
            *(short *)(puVar4 + iVar8 * 0x18 + 6) = *(short *)((int)puVar15 + -10);
            ...
            uVar19 = (**(void **)(0x0602A820 + ((int)*(short *)(puVar15 + -3) & 7U) * 4))
