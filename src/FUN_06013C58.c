...
int FUN_06013c58()
{
  ...
  (*(void(*)())puVar2)(8,*(int *)(puVar3 + DAT_06013cca),0,
  ...
  (*(void(*)())puVar2)(4,*(int *)(puVar3 + DAT_06013cce),0x18,

                    *(int *)((int)(puVar3 + DAT_06013cce) + 4) + iVar8);

  (*(void(*)())puVar2)(4,*(int *)(puVar3 + DAT_06013cd0),(int)DAT_06013cd2,
  ...
  (*(void(*)())puVar2)(4,*(int *)(puVar3 + sVar1),(int)DAT_06013dc8,
  ...
  uVar5 = (*(void(*)())0x06005DD4)(*(int *)(puVar6 + DAT_06013dca));

  (*(void(*)())0x060284AE)(0xc,(int)DAT_06013dce,(int)DAT_06013dcc,uVar5);
  ...
  uVar5 = (*(void(*)())puVar4)(puVar6);

  (*(void(*)())0x060284AE)(0xc,(int)DAT_06013dd0,(int)DAT_06013dcc,uVar5);

  if (*(int *)0x06085FF8 == '\0') {

    uVar5 = (*(void(*)())0x060283E0)(0xc,(int)DAT_06013dd6,0x0000F000,0x06044A58);

    return uVar5;

  }

  (*(void(*)())0x06028430)(0xc,(int)DAT_06013dd2,0x30,(unsigned char)*0x06086012 + 1);
  ...
  uVar5 = (*(void(*)())puVar2)(0xc,*(int *)(puVar3 + (uVar9 + 0x48) * 8),(int)DAT_06013dd4,
