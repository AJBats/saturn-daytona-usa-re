...
int FUN_06006cdc()
{
  ...
  uVar16 = *(int *)0x06063EF0 + (int)DAT_06006da8 & (unsigned int)0x0000FFFF;

  uVar14 = *(int *)(0x06062248 + *(int *)0x0607EAD8 * 8);

  uVar11 = *(int *)(0x06062248 + (*(int *)0x0607EAD8 * 2 + 1) * 4);

  iVar7 = (int)DAT_06006daa;

  iVar8 = (int)PTR_DAT_06006dac;

  iVar9 = *(int *)(0x06062260 + *(int *)0x0607EAD8 * 0x10);

  iVar19 = *(int *)0x0607EAD8 * 4;

  iVar15 = *(int *)(0x06062260 + (iVar19 + 1) * 4);

  iVar12 = *(int *)(0x06062260 + (iVar19 + 2) * 4);
  ...
  for (; uStack_58 < uStack_28; uStack_58 = uStack_58 + 1) {
    ...
    for (uStack_5c = uStack_2c; uStack_5c < uStack_44; uStack_5c = uStack_5c + 1) {
      ...
      iVar19 = (uStack_58 * 0xb + uStack_5c) * 2;

      sVar1 = *(short *)(puVar5 + iVar19 + iVar8 + (uVar16 >> 0xc) * iVar7);

      if (sVar1 != 0) {

        iVar18 = (sVar1 + iVar13) * 2;
        ...
        if (0 < sVar22) {
          ...
          iVar19 = *(int *)(iVar15 + (sVar1 + iVar13) * 4) +

                   *(int *)(0x06062230 + *(int *)puVar4 * 8);
        ...
        if (0 < sVar21) {
          ...
          iVar19 = *(int *)(0x06062230 + (*(int *)puVar4 * 2 + 1) * 4) +

                   *(int *)(iVar10 + (sVar1 + iVar13) * 4);
