...
void FUN_0601a65e()
{
  ...
  if (*(int *)0x0605D241 == '\0') {
    ...
    (*(void(*)())0x06028400)(0xc,*(int *)(0x06063750 + DAT_0601a6de),(int)DAT_0601a6e0,
    ...
    (*(void(*)())0x06028400)(0xc,*(int *)(0x06063750 + DAT_0601a756),(int)DAT_0601a758,
  ...
  (*(void(*)())puVar2)(0xc,*local_18,(int)PTR_DAT_0601a75c,iVar3);
