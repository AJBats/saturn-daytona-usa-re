...
void FUN_06014360()
{
  ...
  do {
    ...
    (*puVar2)(0,iVar5,0x00010000);

    (*puVar1)((int)*(short *)(puVar6 + 6));
    ...
    (*0x06026E60)(iVar8,iVar8,iVar8);

    (*0x06031D8C)(*(int *)(0x06062338 + uVar7 * 4),4);

    (*0x06031A28)

              (*(int *)(0x060622C0 + uVar7 * 4),(int)*(short *)puVar4,1);
