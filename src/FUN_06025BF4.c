  ...
  if (*0x06061199 == '\0') {
    ...
    if (iVar6 < 6) {
      ...
      do {
        ...
        (*puVar2)(piVar11[1] << 2,*(int *)(0x06063750 + *piVar11 * 8),
  ...
  if (*0x06061199 != '\0') {
    ...
    if (-1 < *(int *)puVar4) {
      ...
      if (iVar6 < 6) {
        ...
        (*0x0601A3F4)(*(unsigned int *)puVar4 & 0xffff,uVar1);
      ...
      (*puVar2)(*(int *)((int)(0x0605900C + *(int *)puVar4 * 8) + 4) << 2,
      ...
      (*puVar2)(*(int *)(0x0605900C + *(int *)puVar4 * 8 + 4) << 2,
