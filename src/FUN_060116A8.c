void FUN_060116a8(int param_1,int param_2,short param_3,int param_4,
{
  ...
  (*0x06027358)((int)param_3,&uStack_2c,&uStack_28);
  ...
  iVar5 = (*0x06027552)(0xFFC80000,uStack_28);

  iVar6 = (*puVar4)(0x001E0000,uStack_2c);

  uVar7 = (*puVar4)(iVar5 - iVar6,param_4);

  sVar8 = (*puVar3)(uVar7);

  sVar9 = (*puVar3)(param_1);

  *psVar11 = sVar9 + sVar8;

  sVar8 = *(short *)puVar2;

  iVar5 = (*puVar4)(0xFFC80000,uStack_2c);

  iVar6 = (*puVar4)(0x001E0000,uStack_28);

  uVar7 = (*puVar4)(iVar5 + iVar6,param_4);

  sVar9 = (*puVar3)(uVar7);

  sVar10 = (*puVar3)(param_2);

  *(short *)(puVar1 + (short)(sVar8 * 0x18) + 10) = sVar10 + sVar9;

  sVar8 = *(short *)puVar2;

  iVar5 = (*puVar4)(0x00380000,uStack_28);
  ...
  sVar10 = (*puVar3)(param_1);

  *(short *)(puVar1 + (short)(sVar8 * 0x18) + 0xc) = sVar10 + sVar9;

  sVar8 = *(short *)puVar2;

  iVar5 = (*puVar4)(0x00380000,uStack_2c);
  ...
  *(short *)(puVar1 + (short)(sVar8 * 0x18) + 0xe) = sVar10 + sVar9;
  ...
  iVar6 = (*puVar4)(0xFFE20000,uStack_2c);
  ...
  *(short *)(puVar1 + (short)(sVar8 * 0x18) + 0x10) = sVar10 + sVar9;
  ...
  iVar6 = (*puVar4)(0xFFE20000,uStack_28);
  ...
  *(short *)(puVar1 + (short)(sVar8 * 0x18) + 0x12) = sVar10 + sVar9;
  ...
  iVar5 = (*puVar4)(0xFFC80000,uStack_28);
