unsigned int FUN_06032ea4()
{
  ...
  (*0x06026E2E)
            ...
            (*(int *)(unaff_r14 + 0x00000000),*(int *)(unaff_r14 + 0x00000004),

             *(int *)(unaff_r14 + 0x00000008),in_r7,in_pr);

  (*0x06026EDE)((int)*(short *)(unaff_r14 + 0x0000000C));
  ...
  if ((0x00000004 & uVar1) != 0) {
    ...
    (*0x06026E2E)
              ...
              (*(int *)0x060624C8,*(int *)(0x060624C8 + 4),

               *(int *)(0x060624C8 + 8),in_r7,in_pr);

    (*0x06026F2A)(*(int *)(0x060624C8 + 0xc));
  ...
  if ((0x00000008 & uVar1) != 0) {
    ...
    (*0x06026E2E)
              ...
              (*(int *)(0x060624C8 + 0x10),*(int *)(0x060624C8 + 0x14),

               *(int *)(0x060624C8 + 0x18),in_r7,in_pr);

    (*0x06026F2A)(*(int *)(0x060624C8 + 0x1c));
  ...
  if ((0x00000010 & uVar1) != 0) {
    ...
    (*0x06026E2E)
              ...
              (*(int *)(0x060624C8 + 0x20),*(int *)(0x060624C8 + 0x24),

               *(int *)(0x060624C8 + 0x28),in_r7,in_pr);

    (*0x0600A474)(0x00000000);
