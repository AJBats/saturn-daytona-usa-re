...
.L_060425A4:
    ...
    mov.l r6, @(r0, r2)
    mov.l   .L_pool_0604287C, r6
    mov.l r5, @(r0, r2)
    mov.l   .L_pool_06042618, r9
    mov.b r4, @(r0, r2)
    mov.l   .L_pool_06042774, r11
    mov.b r3, @(r0, r2)
    mov.l   .L_pool_06042888, r13
    .word 0x0221 /* UNKNOWN */
    mov.l   .L_pool_0604295C, r15
    .word 0x0211 /* UNKNOWN */
    mov #0x8, r2
    mov.l @(r0, r15), r1
    mov #0x19, r4
...
.L_0604269E:
    ...
    sts macl, r4
    xtrct r3, r4
    mov.l   .L_pool_06042708, r2
    cmp/gt r2, r4
    bf      .L_060426C4
    mov.l   .L_pool_06042708, r4
.L_060426C4:
    mov r14, r0
    shll16 r0
    cmp/pz r12
