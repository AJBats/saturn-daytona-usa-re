...
vdp1_display_submit:
    ...
    mov #0x0, r12
    mov.l @(r0, r1), r10
    mov.w   .L_wpool_0602D48C, r11
    mov.w   DAT_0602d48e, r2
    mov.w @(r0, r2), r7
    cmp/pl r7
    bt      .L_0602D4A4
    mov.w   .L_wpool_0602D490, r3
    mov.l   .L_pool_0602D498, r5
    neg r3, r4
    mov.l @(8, r0), r7
    mov.w   .L_wpool_0602D492, r8
    cmp/gt r7, r8
    bt      .L_0602D4A4
    mov.w   .L_wpool_0602D494, r2
    mov.l @(r0, r2), r9
    tst r9, r9
    bt      .L_0602D4A4
...
.L_0602D590:
    ...
    cmp/ge r4, r2
    bt      .L_0602D5D6
    mov.w   .L_wpool_0602D5F6, r1
    mov.l @(r0, r1), r2
    mov.w   .L_wpool_0602D5F8, r3
    mov.l @(r0, r3), r4
    xor r2, r4
    cmp/pz r4
    bt      .L_0602D5D6
...
.L_0602D610:
    neg r6, r11
    mov r14, r0
    mov.w   .L_wpool_0602D62C, r1
    mov.l @(r0, r1), r5
    sub r11, r10
    sub r5, r10
    add r10, r5
    mov.w   .L_wpool_0602D62E, r3
    neg r3, r4
    cmp/gt r4, r5
    bt      .L_0602D630
    mov r4, r5
...
.L_0602D636:
    ...
    sub r6, r5
    mov.l r5, @(r0, r2)
    mov.w   .L_wpool_0602D67E, r1
    mov.w   .L_wpool_0602D680, r2
    mov.l @(r0, r1), r3
    mov.l @(r0, r2), r4
    dmuls.l r3, r4
    sts mach, r3
    ...
    tst r3, r3
    bf      .L_0602D688
    mov.l   .L_fp_quarter_0602D684, r6
    bra     .L_0602D6AC
    nop
...
.L_0602D688:
    ...
    mov.l r4, @(20, r2)
    mov.l @(28, r2), r4
    mov.l   .L_pool_0602D6C4, r0
    jsr @r0
    nop
    cmp/eq #0x0, r0
    bf      .L_0602D6AA
    mov.w   .L_wpool_0602D6C0, r4
    add r14, r4
    mov.b @r4, r0
.L_0602D6AA:
    mov r0, r6
...
.L_0602D7A8:
    ...
    or r3, r2
    mov.l   .L_fp_0x4000_0000_0602D7BC, r3
    or r3, r2
    bra     .L_0602D7C0
    mov.l r2, @(0, r0)
    .2byte  0x0000
