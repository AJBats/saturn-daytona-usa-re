...
state_boot_init:
    sts.l pr, @-r15
    mov.l   .L_pool_fn_init_reset, r3
    jsr @r3
    nop
    mov.l   .L_pool_fn_render_stage1, r3
    jsr @r3
    nop
    mov #0x0, r6
    mov.l   .L_fp_neg_one, r5
    mov.l   .L_pool_fn_disp_chan_b, r3
    jsr @r3
    mov #0x4, r4
    mov #0x0, r6
    mov #0x2, r5
    mov.l   .L_pool_fn_handler_disp, r3
    jsr @r3
    mov r5, r4
    mov.l   .L_pool_fn_obj_render, r3
    jsr @r3
    nop
    mov #0x1, r2
    mov.l   .L_pool_game_state, r3
    mov.l r2, @r3
    mov.l   .L_pool_fn_disp_update, r3
    jsr @r3
    nop
    mov #0x0, r2
    ...
    .global loc_0600890A
loc_0600890A:
    mov.l   .L_pool_fn_render_stage2, r3
    jmp @r3
    nop
