...
scene_render_alt:
    ...
    mov.l @r5, r14
    mov.l @(8, r5), r12
    mov.l   .L_pool_06027F14, r11
    mov.l   .L_pool_06027F18, r10
    mov.l   .L_pool_06027F1C, r0
    mov.l @r0, r0
    cmp/eq #0x2, r0
    bt      .L_06027F20
    mov r4, r0
...
.L_06027F38:
    ...
    bt      .L_06027F64
    shll r9
    mov.l   .L_pool_06027F5C, r0
    add r9, r0
    mov.l   .L_pool_06027F60, r1
    mov.w @r0+, r2
    mov.w @r0, r9
    bra     .L_06027F66
    mov.w r2, @r1
...
sym_060280F8:
    ...
    mov.w @(r0, r1), r7
    mulu.w r2, r7
    mov.l   .L_pool_06028164, r1
    mov #0x6, r0
    sts macl, r2
    add r2, r1
    mov.w @(r0, r1), r6
    mov.l   .L_pool_06028168, r3
    mov.b @(4, r4), r0
    and #0xC, r0
    add r0, r3
    mov.l @r3, r0
    mov.w r0, @(0, r5)
    mov.b @(4, r4), r0
    mov.l   .L_pool_0602816C, r2
    and #0x1, r0
    shll r0
    add r2, r0
    mov.w @r0, r0
    mov.w r0, @(4, r5)
    mov.l   .L_pool_06028170, r3
    mov.l @r3, r0
    mov #0x8, r3
    mulu.w r3, r7
    add r6, r0
    mov.w r0, @(6, r5)
    mov.l   .L_pool_06028164, r2
    sts macl, r3
    add r3, r2
    mov.l @(0, r2), r0
    mov.l @(20, r4), r1
...
.L_0602825E:
    ...
    mov.l @(36, r15), r6
    mov.l   .L_pool_060282A0, r4
    mov.l   .L_pool_060282A4, r5
    mov.w   .L_wpool_0602829C, r6
    mov.l   .L_pool_060282A8, r7
    jsr @r7
    mov.l @r4, r4
    lds.l @r15+, pr
    mov.l @r15+, r0
