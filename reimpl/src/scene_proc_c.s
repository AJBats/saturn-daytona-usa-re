...
.L_0602AF6C:
    mov.l r7, @-r15
    add #-0x18, r8
    mov.l   .L_sym_0602B2C8, r11
    mov.l   .L_sym_0602B2E8, r5
    ...
    mov.l r2, @(4, r5)
    mov.l r3, @(8, r5)
    mov.l   .L_sym_0602B310, r7
    mov.l r2, @r7
    mov.w @(12, r8), r0
    tst #0x8, r0
    bf      .L_0602B000
    mov.l   .L_sym_0602B2F8, r7
    mov r8, r4
    clrmac
    mac.l @r4+, @r6+
    mac.l @r4+, @r6+
...
.L_0602B0DA:
    ...
    mov.b r0, @(5, r9)
    mov.w @(12, r8), r0
    mov.l   .L_sym_0602B314, r1
    and #0x7, r0
    shll2 r0
    mov.l @(r0, r1), r2
    mova    sym_0602B2E8, r0
    mov.l @r0, r3
    mov.l @(4, r0), r4
    mov.l @(8, r0), r5
    jmp @r2
