...
.L_0602F2B6:
    ...
    mov r14, r0
    mov.l r4, @(r0, r3)
    /* 30fps: gear shift duration 5 -> 8 (x3/2, preserves ~250ms transition)
       LONG TERM: decouple from frame rate entirely (option C — use real
       timer based on VBlank/cycle count instead of frame counter. This
       would make the gear transition feel identical at any frame rate.) */
    mov #0x8, r5
    mov.w   .L_0602F2FA, r1
    bra     .L_0602F34C
    mov.l r5, @(r0, r1)
...
.L_0602F304:
    ...
    mov.l r4, @(r0, r1)
    /* 30fps: gear shift duration 5 -> 8 (x3/2, preserves ~250ms transition)
       LONG TERM: option C — real timer, not frame counter */
    mov #0x8, r4
    neg r4, r4
    mov.w   .L_0602F38E, r3
    mov.l r4, @(r0, r3)
...
.L_0602F430:
    ...
    .2byte  0x0000
.L_0602F43C:
    .4byte  0x00001C71    /* 30fps: drag clamp 10922 -> 7281 (x2/3) */
.L_0602F440:
    mov.l   .L_0602F46C, r4
    cmp/ge r2, r4
    bt      .L_0602F448
...
.L_0602F468:
    ...
    .2byte  0x0000
.L_0602F46C:
    .4byte  0x00000716    /* 30fps: drag alt clamp 2730 -> 1820 (x2/3) */
.L_0602F470:
    .4byte  0x00001C71    /* 30fps: drag clamp 10922 -> 7281 (x2/3) */
