...
.L_0602CE12:
    ...
    mov.l r7, @-r15
    mov.l r9, @-r15
    .byte   0xDD, 0x09    /* mov.l .L_0602CE4C, r13 */
    mov.l r8, @-r15
    jsr @r13
    mov.l r6, @-r15
    mov r0, r5
    jsr @r13
    mov r9, r4
    .byte   0xD7, 0x07    /* mov.l .L_0602CE50, r7 */
    dmuls.l r7, r0
    tst r5, r5
    sts mach, r0
    sts macl, r4
...
.L_0602CE60:
    ...
    xtrct r0, r3
    mov r3, r11
    .byte   0xD0, 0x0C    /* mov.l .L_0602CEA4, r0 */
    jsr @r0
    nop
    dmuls.l r10, r0
    shlr r7
    ...
    xtrct r0, r5
    add r7, r5
    .byte   0xD0, 0x08    /* mov.l .L_0602CEA8, r0 */
    jsr @r0
    mov r3, r4
    mov r0, r4
    mov r0, r7
...
.L_0602CED4:
    ...
    jsr @r0
    nop
    .byte   0xD5, 0x09    /* mov.l .L_0602CF00, r5 */
    mov #0x0, r2
    cmp/pz r0
    bt      .L_0602CEE6
    mov #0x1, r2
...
.L_0602CF08:
    ...
    add r5, r2
    exts.w r2, r2
    .byte   0xD3, 0x09    /* mov.l .L_0602CF38, r3 */
    mov.l r2, @(48, r0)
    mov.l r5, @(r0, r3)
    mov.l @r15+, r8
    mov.l @r15+, r9
...
.L_0602CF22:
    ...
    cmp/eq r4, r2
    bt      .L_0602CF40
    .byte   0xD3, 0x03    /* mov.l .L_0602CF3C, r3 */
    bra     .L_0602CF44
    mov.l r7, @(r0, r3)
.L_0602CF34:
    .2byte  0x0252
...
.L_0602CF44:
    ...
    mov r2, r4
    mov.l @(12, r0), r2
    .byte   0xD0, 0x24    /* mov.l .L_0602CFE8, r0 */
    jsr @r0
    nop
    dmuls.l r2, r0
    .byte   0xD3, 0x23    /* mov.l .L_0602CFEC, r3 */
    sts mach, r0
    sts macl, r5
    xtrct r0, r5
    dmuls.l r3, r5
    .byte   0xD3, 0x22    /* mov.l .L_0602CFF0, r3 */
    sts mach, r2
    sts macl, r5
    xtrct r2, r5
    dmuls.l r3, r5
    ...
    .byte   0xD2, 0x13    /* mov.l .L_0602CFF4, r2 */
    add #0x4, r2
    mov.l @(r0, r1), r4
    shar r4
    shar r4
...
DAT_0602d076:
    ...
    .global DAT_0602d078
DAT_0602d078:
    .2byte  0x0028    /* 30fps: heading correction 60 -> 40 (x2/3) */
.L_0602D07A:
    cmp/ge r5, r6
    bt      .L_0602D080
    mov r6, r5
