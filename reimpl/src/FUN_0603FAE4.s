...
.L_0603FB2C:
    mov r9, r6
    mov r10, r5
    .reloc ., R_SH_IND12W, FUN_0603FC60 - 4
    .2byte 0xB000    /* bsr FUN_0603FC60 (linker-resolved) */
    mov r14, r4
    mov.l @(4, r14), r0
    tst r0, r0
    bf      .L_0603FB3E
...
.L_0603FB50:
    mov r9, r6
    mov r10, r5
    .reloc ., R_SH_IND12W, FUN_0603FCE4 - 4
    .2byte 0xB000    /* bsr FUN_0603FCE4 (linker-resolved) */
    mov r14, r4
    mov.l @(12, r14), r0
    tst r0, r0
    bf      .L_0603FB62
