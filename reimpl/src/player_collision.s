...
player_collision:
    ...
    sts.l pr, @-r15
    add #-0x4, r15
    .byte   0xDA, 0x0E    /* mov.l .L_pool_0600C620, r10 */
    .byte   0xDB, 0x0F    /* mov.l .L_pool_0600C624, r11 */
    .byte   0xDE, 0x0F    /* mov.l .L_pool_0600C628, r14 */
    .byte   0xDD, 0x10    /* mov.l .L_pool_0600C62C, r13 */
    .byte   0xB3, 0xA8    /* bsr 0x0600CD40 (external) */
    mov.l @r14, r14
    mov r0, r12
    .byte   0xD0, 0x0F    /* mov.l .L_pool_0600C630, r0 */
    mov.w @r0, r0
    extu.w r0, r0
    cmp/eq #0x2, r0
    bt/s    .L_0600C60E
...
.L_pool_0600C630:
    .4byte  sym_06087804
.L_0600C634:
    .byte   0xD2, 0x33    /* mov.l .L_pool_0600C704, r2 */
    mov.l @r2, r2
    mov r2, r0
    mov.b @(3, r0), r0
    tst #0x8, r0
...
.L_0600C68C:
    ...
    mov r12, r4
.L_0600C692:
    .byte   0xD0, 0x1D    /* mov.l .L_pool_0600C708, r0 */
    mov.w @r0, r0
    extu.w r0, r0
    cmp/eq #0x3, r0
    bf      .L_0600C6AA
...
.L_0600C6AA:
    ...
    mov r14, r4
    .byte   0xD2, 0x16    /* mov.l .L_pool_0600C70C, r2 */
    mov.l @r2, r2
    mov.l @r2, r3
    .byte   0xD2, 0x16    /* mov.l .L_pool_0600C710, r2 */
    and r2, r3
    tst r3, r3
    bf      .L_0600C718
    mov.w @(14, r13), r0
    ...
    mov.l @(40, r14), r4
    .byte   0xD3, 0x12    /* mov.l .L_pool_0600C714, r3 */
    add r14, r6
    add r14, r5
    jsr @r3
    neg r4, r4
...
.L_0600C718:
    ...
    mov.l r5, @-r15
    mov.l @(24, r14), r5
    .byte   0xD3, 0x25    /* mov.l .L_pool_0600C7C4, r3 */
    jsr @r3
    mov.l @(16, r14), r4
    mov r0, r4
    mov.l @r15+, r5
    .byte   0xD3, 0x23    /* mov.l .L_pool_0600C7C8, r3 */
    jsr @r3
    mov.l @r15+, r6
.L_0600C73E:
    add #0x4, r15
