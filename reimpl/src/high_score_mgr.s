...
high_score_mgr:
    sts.l pr, @-r15
    mov.l   .L_pool_score_table_base, r12
    .byte   0xB6, 0x24    /* bsr 0x0603CD5C — display orchestrator: sets up VDP2 channels */
    mov #0x0, r14
    mov.l   .L_pool_render_credits_stub, r3
    jsr @r3
    nop
    mov.l   .L_pool_bus_lock_table_ctrl, r3
    jsr @r3
    nop
    mov.l   .L_pool_display_nop_stub_a, r3
    jsr @r3
    nop
    mov.l   .L_pool_display_nop_stub_b, r3
    jsr @r3
    nop
    mov.l   .L_pool_display_element_draw, r3
    jsr @r3
    nop
    extu.b r14, r4
.L_clear_loop:
    ...
    mov.l r14, @(r0, r12)
    mov #0x0, r2
    mov.l   .L_pool_score_state_word, r3
    mov.l r2, @r3
    mov.l   .L_pool_score_active_flag, r2
    mov.b r14, @r2
    lds.l @r15+, pr
    mov.l @r15+, r12
    mov.l @r15+, r13
    ...
    .global sym_0603C156
sym_0603C156:
    mov.l   .L_pool_display_mode_reg, r0
    mov.w   .L_wpool_mode_field_mask, r3
    mov.w @r0, r0
    extu.w r0, r0
    and r3, r0
    shar r0
