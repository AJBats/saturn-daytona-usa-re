...
ai_master_update:
    sts.l pr, @-r15
    add #-0x8, r15
    .byte   0xD3, 0x0B    /* mov.l .L_pool_06036BD8, r3 */
    jsr @r3
    mov r15, r4
    mov r15, r2
    mov #0x75, r3
    ...
    .byte   0xD3, 0x09    /* mov.l .L_pool_06036BE0, r3 */
    jsr @r3
    nop
    mov.w   .L_wpool_06036BCE, r4
    .byte   0xD3, 0x06    /* mov.l .L_pool_06036BDC, r3 */
    jsr @r3
    mov r15, r5
    add #0x8, r15
    lds.l @r15+, pr
...
.L_06036C8A:
    ...
    mov.l @r15+, r2
.L_06036C96:
    .byte   0xD1, 0x03    /* mov.l .L_pool_06036CA4, r1 */
    .byte   0xD2, 0x03    /* mov.l .L_pool_06036CA8, r2 */
    mov #0x0, r0
    mov.l r2, @r1
    rts
    mov.l @r15+, r2
...
.L_06036D60:
    ...
    mov.l @r15+, r3
.L_06036D6C:
    .byte   0xD3, 0x01    /* mov.l .L_pool_06036D74, r3 */
    jmp @r3
    nop
    .2byte  0x0009
.L_pool_06036D74:
