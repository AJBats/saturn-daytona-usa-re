...
event_timer_sched:
    ...
    bt/s    .L_06040B54
    mov r4, r13
    .byte   0xA0, 0x51    /* bra 0x06040BF2 (external) */
    mov #0x0, r0
.L_pool_06040B50:
    .4byte  sym_0606367C
.L_06040B54:
    ...
    bt/s    .L_06040B72
    add #0x4, r15
    .byte   0xA0, 0x40    /* bra 0x06040BF2 (external) */
    mov #0x0, r0
.L_06040B72:
    ...
    tst r0, r0
    bt      .L_06040B80
    .byte   0xA0, 0x39    /* bra 0x06040BF2 (external) */
    mov #0x0, r0
.L_06040B80:
    mov.l @(4, r15), r3
    cmp/pl r3
    bt      .L_06040B8A
    .byte   0xA0, 0x34    /* bra 0x06040BF2 (external) */
    mov #0x0, r0
.L_06040B8A:
    mov r14, r6
    mov r14, r5
