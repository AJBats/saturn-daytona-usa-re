...
obj_pool_dealloc:
    ...
    mov r15, r7
    mov r15, r1
    mov.l   .L_pool_obj_data_src, r2
    mov.l   .L_pool_input_state, r6
    mov.l   .L_pool_anim_state_a, r5
    mov.l   .L_pool_lap_counter, r4
...
_no_increment:
    mov.w @(2, r6), r0
    mov.w   .L_wpool_mask_decrement, r3
    mov r0, r2
    extu.w r2, r2
    and r3, r2
    tst r2, r2
