...
texture_bank_setup:
    ...
    mov.l r8, @-r15
    sts.l pr, @-r15
    mov.l   .L_pool_0603715C, r9
    mov.l   .L_pool_06037160, r10
    mov.l   .L_pool_06037164, r12
    mov.l   .L_pool_06037168, r13
    mov.l   .L_pool_0603716C, r14
    mov.l r3, @r10
    mov.l r3, @(4, r10)
    mov.l @r11, r3
    mov.l r3, @r14
...
.L_06037484:
    ...
    tst r0, r0
    bf      .L_060374B2
    mov.l   .L_pool_06037544, r3
    jsr @r3
    nop
    cmp/eq #0x1, r0
    bf      .L_060374B2
    mov.l   .L_pool_06037548, r3
    mov.w @(14, r12), r0
    mov r0, r2
    or r3, r2
    mov r2, r0
    mov.w r0, @(14, r12)
    mov.l   .L_pool_0603754C, r3
    mov.l r3, @r10
    bra     .L_060375F2
    nop
.L_060374B2:
...
.L_06037578:
    ...
    mov r3, r0
    mov.w r0, @(6, r13)
    mov.l   .L_pool_06037608, r0
    mov.l   .L_pool_0603760C, r3
    jsr @r3
    mov.l @r4, r1
    extu.w r0, r0
    mov #0x6, r2
