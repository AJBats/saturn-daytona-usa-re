...
.L_060372A4:
    ...
    mov.w r0, @(6, r13)
    mov.l @(4, r14), r3
    mov.l   .L_vdp2_vram_0x20000_06037368, r2
    add r2, r3
    mov.l r3, @(4, r10)
.L_060372C6:
    mov #0x4, r2
...
.L_06037374:
    ...
    mov.w r0, @(6, r13)
    mov.l @(4, r14), r3
    mov.l   .L_vdp2_vram_0x40000_06037444, r2
    add r2, r3
    mov.l r3, @(4, r10)
.L_0603739E:
    mov #0x4, r2
...
.L_06037450:
    ...
    mov.w r0, @(6, r13)
    mov.l @(4, r14), r3
    mov.l   .L_vdp2_vram_0x60000_0603753C, r2
    add r2, r3
    mov.l r3, @(4, r10)
.L_0603747A:
    mov.l @(4, r10), r0
...
.L_06037578:
    ...
    mov.w r0, @(6, r13)
    mov.l @r4, r3
    mov.l   .L_vdp2_vram_0x00000_06037610, r2
    add r2, r3
    mov.l r3, @r10
.L_060375B8:
    mov.l @(4, r14), r0
