...
obj_collision_box:
    ...
    mov #0xC, r4
    mov #0x0, r14
    mov.l   .L_pool_06020C08, r11
    mov.l   .L_pool_06020C0C, r2
    mov.l @r11, r3
    or r2, r3
    mov.l r3, @r11
    mov #0x2, r2
    mov.l   .L_pool_06020C10, r3
    mov.w r2, @r3
    mov.l   .L_pool_06020C14, r13
    mov.l   .L_pool_06020C18, r12
    jsr @r12
    mov.l r14, @r13
    mov.l   .L_pool_06020C0C, r2
    mov.l @r11, r3
...
obj_state_pack:
    sts.l pr, @-r15
    mov.l   .L_pool_06020C2C, r3
    jsr @r3
    mov #0x8, r4
    mov.l   .L_pool_06020C30, r5
    mov.l   .L_pool_06020C34, r3
    jsr @r3
    mov r5, r4
    mov.l   .L_pool_06020C38, r3
    jsr @r3
    nop
    mov.l   .L_pool_06020C08, r4
    mov.l   .L_pool_06020C0C, r2
    mov.l @r4, r3
    or r2, r3
    mov.l r3, @r4
    ...
    mov.w r2, @r3
    mov #0x0, r2
    mov.l   .L_pool_06020C14, r3
    mov.l r2, @r3
    mov.l   .L_pool_06020C18, r3
    jmp @r3
    lds.l @r15+, pr
.L_pool_06020C00:
    .4byte  sym_0607EBF4
