/* vdp1_scaled_sprite -- L3 assembly (SH-2 mnemonics)
...
.L_pool_0602DD58:
    .4byte  0x00000003
.L_0602DD5C:
    .byte   0xD0, 0x46    /* mov.l .L_pool_0602DE78, r0 */
    .byte   0xD2, 0x47    /* mov.l .L_pool_0602DE7C, r2 */
    mov.l r2, @r0
    .byte   0xD2, 0x47    /* mov.l .L_pool_0602DE80, r2 */
    mov.l r3, @r2
    mov.l @r1+, r4
    .byte   0xD2, 0x46    /* mov.l .L_pool_0602DE84, r2 */
    mov.l r4, @r2
    mov.l @r1+, r0
    .byte   0xD2, 0x46    /* mov.l .L_pool_0602DE88, r2 */
    mov.l r0, @r2
    mov.l @r1+, r0
    .byte   0xD2, 0x45    /* mov.l .L_pool_0602DE8C, r2 */
    mov.l r0, @r2
    mov.l @r1+, r0
    .byte   0xD2, 0x45    /* mov.l .L_pool_0602DE90, r2 */
    mov.l r0, @r2
    mov.l @r1+, r0
    .byte   0xD2, 0x44    /* mov.l .L_pool_0602DE94, r2 */
    mov.l r0, @r2
    mov.l @r1+, r0
    .byte   0xD2, 0x44    /* mov.l .L_pool_0602DE98, r2 */
    mov.l r0, @r2
    mov r3, r0
    .byte   0xD1, 0x43    /* mov.l .L_pool_0602DE9C, r1 */
    tst r1, r0
    .byte   0x89, 0x10    /* bt 0x0602DDB4 (external) */
    .byte   0xD1, 0x3D    /* mov.l .L_pool_0602DE88, r1 */
    mov.l @r1, r1
    .byte   0xD0, 0x42    /* mov.l .L_pool_0602DEA0, r0 */
    mov.l @r0, r0
    sub r0, r1
    mov r4, r0
    .byte   0xDC, 0x41    /* mov.l .L_pool_0602DEA4, r12 */
