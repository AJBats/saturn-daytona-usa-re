 ...
 *
 * Scene graph entity processor — iterates over track-side entities (signs,
 * buildings, trees) and dispatches rendering based on distance and type.
 *
 * Entity stride is 24 bytes (index * 24 computed as index*8 + index*16).
 * Distance culling at 0x6A0000 per axis. LOD thresholds at 0x46, 0x1E.
 * Entity types: 0=initial, 1=active, 3=type_a, 4=type_b.
 * Sound triggers: 0xAE110BFF (type 0), 0xAE110DFF (other types).
 *
 * Key data:
 *   DAT_060224b6 = 0x2000 — close LOD distance bonus
 */
