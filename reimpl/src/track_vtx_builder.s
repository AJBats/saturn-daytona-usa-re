...
track_vtx_builder:
    ...
    mov.l r8, @-r15
    sts.l pr, @-r15
    mov.w   .L_wpool_frame_size_neg, r0
    add r0, r15
    mov r15, r8
    mov r15, r9
    mov r15, r10
    mov.l   .L_pool_fn_fpmul, r14
    mov r4, r0
    add #0x1C, r8
    add #0x4C, r9
    add #0x3C, r10
...
.L_corner_loop_check:
    ...
    mov.b @(12, r15), r0
    mov.l   .L_pool_slot_data_base_b, r1
    mov r0, r3
    extu.b r3, r3
    mov r3, r2
    shll2 r3
...
.L_no_angle_bias:
    ...
    mov r15, r5
    mov.b @(12, r15), r0
    mov.l   .L_pool_slot_data_base_b, r2
    add #0x4, r6
    mov r0, r4
    extu.b r4, r4
    mov r4, r3
...
.L_adjust_y_delta:
    mov.l @r5, r5
    mov.l   .L_pool_fn_fpdiv_c, r3
    jsr @r3
    mov r2, r4
    mov r0, r1
    mov.l   .L_pool_fn_geom_xform, r2
    jsr @r2
    mov #0x6, r0
    mov.l @(8, r15), r3
    sub r0, r3
...
.L_y_delta_next:
    ...
    mov.b @(12, r15), r0
    mov.l   .L_pool_slot_data_base_c, r1
    mov r0, r3
    extu.b r3, r3
    mov r3, r2
    shll2 r3
    ...
    add r2, r3
    exts.w r3, r3
    mov.l   .L_pool_vtx_table_base, r1
    add r1, r3
    add #0x8, r3
    mov.l r3, @(16, r15)
    mov #0x0, r11
...
.L_screen_vtx_loop_top:
    ...
    mov.l @(r0, r9), r4
    mov.l @(4, r12), r4
    mov.l   .L_pool_fn_swap_sign_ext, r3
    jsr @r3
    add r0, r4
    exts.w r0, r0
    mov.l @r15+, r2
    ...
    mov.w   .L_wpool_frame_size_pos, r1
    add r1, r15
    lds.l @r15+, pr
    mov.l @r15+, r8
    mov.l @r15+, r9
