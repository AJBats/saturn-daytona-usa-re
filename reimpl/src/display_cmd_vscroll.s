...
.L_060325F8:
    add r14, r1
.L_060325FA:
    mov.l   .L_offset_0x2d4, r0
    mov.l r1, @(r0, r14)
    mov.l   .L_const_0x00d, r7
.L_06032600:
    mov.l r7, @-r15
...
disp_rank_elem_a:
    ...
    lds.l @r15+, pr
    mov.l @r15+, r7
    mov.l   .L_const_0x00d, r0
    sub r7, r0
    mov.l   .L_const_0x2de_2, r1
    add r14, r1
    mov.b @(r0, r1), r4
...
disp_util_main:
    ...
    nop
    lds.l @r15+, pr
    mov.l   .L_offset_0x010_3, r8
    mov.l   .L_offset_0x018_3, r9
    mov.l @(r0, r8), r13
    mov.l @(r0, r9), r14
...
.L_mask_16bit:
    .4byte  0x0000FFFF
.L_0603316C:
    mov.l   .L_offset_0x020_2, r2
    mov.l @(r0, r2), r4
    mov.l   .L_offset_0x1d8, r2
    mov.l @(r0, r2), r3
    add r3, r4
    add r3, r4
    neg r4, r6
