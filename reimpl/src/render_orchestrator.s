...
render_orchestrator:
    mov.l r14, @-r15
    sts.l pr, @-r15
    mov.l   .L_pool_0602EF00, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF04, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF08, r1
    mov #0x0, r2
    mov.l r2, @r1
    mov.w   .L_wpool_0602EEFA, r1
    mov.w @(r0, r1), r2
    add #0x2, r1
    mov.w r2, @(r0, r1)
    mov.l   .L_pool_0602EF0C, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF10, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF14, r13
    jsr @r13
    nop
    mov.w   .L_wpool_0602EEFC, r1
    mov.w @(r0, r1), r2
    tst r2, r2
    bt      .L_0602EF1C
    mov.l   .L_pool_0602EF18, r13
    jsr @r13
    nop
    bra     .L_0602EF22
    nop
...
.L_0602EF1C:
    mov.l   .L_pool_0602EF64, r13
    jsr @r13
    nop
.L_0602EF22:
    mov.l   .L_pool_0602EF68, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF6C, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF70, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF74, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF78, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF7C, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EF80, r13
    jsr @r13
    nop
    mov.w   .L_wpool_0602EF60, r1
    mov.l   .L_pool_0602EF84, r12
    mov.w @(r0, r1), r2
    mov.l   .L_pool_0602EF88, r13
    tst r2, r2
    bt      .L_0602EF8C
    jsr @r12
    nop
...
.L_0602EF8C:
    ...
    nop
.L_0602EF90:
    mov.l   .L_pool_0602EFBC, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EFC0, r13
    jsr @r13
    nop
    mov.l   .L_pool_0602EFC4, r13
    jsr @r13
    nop
    mov.l @(0, r0), r2
...
render_camera_compute:
    ...
    mov.l @(r0, r1), r1
    mov r1, r6
    mov.w   .L_wpool_0602F020, r2
    mov.w   .L_wpool_0602F022, r3
    cmp/pz r1
    bt      .L_0602F014
    neg r1, r1
.L_0602F014:
...
.L_0602F036:
    ...
    mov.l r2, @(r0, r6)
    mov.l r4, @(r0, r1)
    mov.w   .L_wpool_0602F068, r3
    mov.l @(r0, r3), r1
    mov.l   .L_pool_0602F06C, r2
    cmp/ge r1, r2
    bt      .L_0602F070
    bra     .L_0602F078
    mov r2, r1
...
.L_0602F078:
    ...
    sts macl, r1
    mov.l   .L_pool_0602F0AC, r0
    .byte   0xBE, 0x20    /* bsr 0x0602ECCC (external) */
    nop
    mov.l @r15+, r0
    mov.l @(r0, r3), r2
    mov.l r1, @(r0, r3)
    mov.w   .L_wpool_0602F0A2, r3
    mov.l @(r0, r3), r1
    mov.l   .L_pool_0602F0B0, r2
    cmp/ge r1, r2
    bt      .L_0602F0B4
    bra     .L_0602F0BC
    mov r2, r1
...
.L_0602F0BC:
    ...
    mov.l r0, @-r15
    sts macl, r1
    mov.w   .L_wpool_0602F0DE, r0
    .byte   0xBD, 0xFF    /* bsr 0x0602ECCC (external) */
    nop
    mov.l @r15+, r0
    mov.w   .L_wpool_0602F0E0, r3
    mov.l r1, @(r0, r3)
    lds.l @r15+, pr
    mov.l @r15+, r14
    rts
...
.L_0602F134:
    ...
    mov.l r5, @(r0, r1)
    mov #0x0, r5
    mov.w   .L_wpool_0602F162, r1
    mov.l @(r0, r1), r4
    mov.l   .L_pool_0602F164, r2
    cmp/pz r4
    bt      .L_0602F168
    add r2, r4
    cmp/pz r4
...
.L_0602F190:
    ...
    tst r7, r7
    bt      .L_0602F1AC
    mov.l   .L_pool_0602F1C0, r6
    add r2, r6
    mov.l @r6, r6
    cmp/gt r6, r4
    bt      .L_0602F1C8
.L_0602F1AC:
    mov.l   .L_pool_0602F1C4, r6
    add r2, r6
    mov.l @r6, r6
    cmp/ge r4, r6
    bt      .L_0602F1F8
...
.L_0602F286:
    add #0x1, r3
    mov.l r3, @(r0, r1)
    mov.w   .L_wpool_0602F2AC, r2
    mov.w   .L_wpool_0602F2AE, r1
    mov.l @(r0, r2), r3
    mov.l r3, @(r0, r1)
    mov.w   .L_wpool_0602F2B0, r4
    sub r4, r3
    mov.l r3, @(r0, r2)
.L_0602F298:
    mov.w   .L_wpool_0602F2B2, r1
    mov.w @(r0, r1), r2
    mov.w   .L_wpool_0602F2B4, r5
    mov.w @(r0, r5), r6
    cmp/eq r2, r6
    bt      .L_0602F34C
    cmp/gt r2, r6
...
.L_0602F2B6:
    ...
    bt      .L_0602F34C
    mov.w r6, @(r0, r1)
    mov.w   .L_wpool_0602F2F8, r3
    mov.l @(r0, r3), r4
    shll16 r4
    mov r2, r5
    mov.l   .L_pool_0602F2FC, r8
    mov r8, r9
    shll2 r5
    add r5, r8
    mov.l @r8, r7
...
.L_0602F304:
    ...
    bt      .L_0602F34C
    mov.w r6, @(r0, r1)
    mov.w   .L_wpool_0602F388, r3
    mov.l @(r0, r3), r4
    shll16 r4
    mov r2, r5
    mov.l   .L_pool_0602F39C, r8
    mov r8, r9
    shll2 r5
    add r5, r8
    mov.l @r8, r7
    ...
    mov r14, r0
    mov.l r4, @(r0, r3)
    mov.w   .L_wpool_0602F38A, r5
    mov.w   .L_wpool_0602F38C, r1
    add r5, r4
    mov.l r4, @(r0, r1)
    mov #0x5, r4
    neg r4, r4
    mov.w   .L_wpool_0602F38E, r3
    mov.l r4, @(r0, r3)
.L_0602F34C:
    mov.w   .L_wpool_0602F390, r3
    mov.w   .L_wpool_0602F388, r1
    mov.l @(r0, r1), r4
    cmp/gt r4, r3
    bt      .L_0602F360
    mov #-0x1, r4
    extu.b r4, r4
    mov.w   .L_wpool_0602F392, r5
    mov.l r3, @(r0, r1)
    mov.l r4, @(r0, r5)
.L_0602F360:
    mov.w   .L_wpool_0602F394, r6
    mov.w   .L_wpool_0602F396, r2
    mov.l @(r0, r6), r3
    mov.l @(r0, r1), r4
    mov.l @(r0, r2), r5
    add r5, r4
    sub r3, r4
    mov.w   .L_wpool_0602F398, r1
    mov.l   .L_pool_0602F3A4, r7
    mov.w @(r0, r1), r2
    shll2 r2
    shll r2
    add r2, r7
...
.L_0602F448:
    ...
    tst r4, r4
    bt      .L_0602F45A
    mov.l   .L_pool_0602F470, r2
.L_0602F45A:
    mov.w   .L_wpool_0602F468, r1
    mov.l @(r0, r1), r4
    sub r2, r4
    rts
    mov.l r4, @(r0, r1)
...
.L_0602F49A:
    add #0x1, r5
.L_0602F49C:
    mov.l   .L_pool_0602F4B0, r6
    shll2 r5
    add r5, r6
    mov.l @r6, r3
    mov.w   .L_wpool_0602F4AC, r1
    rts
    mov.l r3, @(r0, r1)
...
.L_0602F4C8:
    ...
    mov.w r3, @(r0, r1)
.L_0602F4D4:
    mov.l   .L_pool_0602F520, r5
    mov.l @r5, r5
    mov.l   .L_pool_0602F524, r3
    mov.l @r3, r6
