/* race_utility_fn -- L3 assembly (SH-2 mnemonics)
...
race_utility_fn:
    sts.l pr, @-r15
    .byte   0xD3, 0x14    /* mov.l .L_pool_0600C2DC, r3 */
    jsr @r3
    nop
    .byte   0xD3, 0x14    /* mov.l .L_pool_0600C2E0, r3 */
    jsr @r3
    nop
    .byte   0xD4, 0x13    /* mov.l .L_pool_0600C2E4, r4 */
    mov.b @r4, r2
    tst r2, r2
    bf      .L_0600C2EC
    .byte   0xD3, 0x12    /* mov.l .L_pool_0600C2E8, r3 */
    jsr @r3
    nop
    bra     .L_0600C2F8
    nop
...
.L_0600C2EC:
    ...
    cmp/eq #0x1, r0
    bf      .L_0600C2F8
    .byte   0xD3, 0x21    /* mov.l .L_pool_0600C378, r3 */
    jsr @r3
    nop
.L_0600C2F8:
...
sym_0600C302:
    mov #0x68, r0
    .byte   0xD4, 0x1F    /* mov.l .L_pool_0600C384, r4 */
    mov.l @r4, r4
    mov.l @(r0, r4), r3
    add #0x7C, r0
    shll2 r3
