...
race_start_transition:
    ...
    mov.b r2, @r3
    .byte   0xB9, 0xAC    /* bsr 0x06019928 (external) */
    nop
    .byte   0xB0, 0x45    /* bsr 0x0601A65E (external) */
    nop
    .byte   0xB1, 0x1A    /* bsr 0x0601A80C (external) */
    nop
    .byte   0xB1, 0xB2    /* bsr 0x0601A940 (external) */
    nop
...
.L_pool_0601A654:
    .4byte  sym_06063D9E
.L_0601A658:
    .byte   0x90, 0x40    /* mov.w .L_wpool_0601A6DC, r0 */
    rts
    nop
