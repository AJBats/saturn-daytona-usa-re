 ...
 * Translation unit: 0x0603950C - 0x0603AC1C
...
.L_0603A6C0:
    mov #0x1, r3
    mov #0x0, r4
    mov.l   .L_pool_0603A700, r2
    extu.b r4, r0
    mov.b r3, @r2
    extu.b r4, r3
    mov.l   .L_pool_0603A704, r2
    mov.b r3, @r2
    mov.l   .L_pool_0603A708, r2
    extu.b r4, r3
    mov.b r4, @r2
    mov.l   .L_pool_0603A70C, r2
    mov.b r0, @r2
    extu.b r4, r0
    mov.l   .L_pool_0603A710, r2
    mov.b r3, @r2
    mov.l   .L_pool_0603A714, r2
    mov.b r4, @r2
    mov.l   .L_pool_0603A718, r2
    mov.b r0, @r2
    mov.l   .L_pool_0603A71C, r3
    mov.l r4, @r3
    mov.l   .L_pool_0603A720, r3
    mov.l r4, @r3
    mov.l   .L_pool_0603A724, r3
    mov.l r4, @r3
    mov.l   .L_pool_0603A728, r3
    rts
    mov.b r4, @r3
.L_wpool_0603A6FA:
    .2byte  0x00E1
