...
sym_0602ECCC:
    ...
    .global sym_0602ECF2
sym_0602ECF2:
    mov.l   .L_pool_0602ED0C, r1
    mov.l @r1, r2
    mov.l   .L_pool_0602ED10, r3
    shll2 r2
    add r2, r3
    mov.l @r3, r3
    jmp @r3
