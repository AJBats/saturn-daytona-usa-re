...
vdp1_sprite_cmd:
    ...
    .byte   0xD5, 0x10    /* mov.l .L_pool_0602D0E0, r5 */
    mov.l @(8, r0), r7
...
.L_0602D134:
    ...
    mov.l @(r0, r1), r4
    .byte   0xDD, 0x17    /* mov.l .L_pool_0602D198, r13 */
    jsr @r13
    shll16 r10
    dmuls.l r0, r10
    sts mach, r0
    ...
    or r3, r4
    mov.l @(12, r0), r2
    .byte   0xD3, 0x0A    /* mov.l .L_pool_0602D19C, r3 */
    cmp/ge r3, r2
    bt      .L_0602D1A4
    mov #0x0, r3
...
.L_0602D1A4:
    ...
    shll16 r4
    mov.l r4, @(20, r2)
    .byte   0xDD, 0x1F    /* mov.l .L_pool_0602D240, r13 */
    mov.l @(28, r2), r4
    jsr @r13
    nop
    cmp/eq #0x0, r0
...
.L_0602D1D4:
    ...
    shll16 r6
    sts macl, r4
    .byte   0xD0, 0x10    /* mov.l .L_pool_0602D244, r0 */
    jsr @r0
    nop
    dmuls.l r0, r6
    sts mach, r2
...
.L_0602D254:
    ...
    sub r5, r10
    add r10, r5
    .byte   0xD3, 0x04    /* mov.l .L_pool_0602D274, r3 */
    neg r3, r4
    cmp/gt r4, r5
    bt      .L_0602D278
    mov r4, r5
...
.L_0602D2D0:
    ...
    shll16 r4
    mov.l r4, @(20, r2)
    .byte   0xD0, 0x0A    /* mov.l .L_pool_0602D30C, r0 */
    mov.l @(28, r2), r4
    jsr @r0
    nop
    cmp/eq #0x0, r0
...
.L_0602D316:
    sub r3, r4
    sub r3, r7
    .byte   0xDC, 0x1C    /* mov.l .L_pool_0602D38C, r12 */
    shll8 r7
    mov r4, r0
    jsr @r12
    mov r7, r1
    ...
    cmp/pz r7
    bt      .L_0602D37C
    .byte   0xD4, 0x0C    /* mov.l .L_pool_0602D390, r4 */
    cmp/pz r3
    bt      .L_0602D366
    neg r4, r4
.L_0602D366:
    ...
    neg r3, r3
    dmuls.l r3, r6
    .byte   0xDC, 0x07    /* mov.l .L_pool_0602D38C, r12 */
    mov r4, r0
    mov.l r1, @-r15
    jsr @r12
    sts macl, r1
...
.L_0602D3A0:
    shll8 r6
    .byte   0xDC, 0x12    /* mov.l .L_pool_0602D3EC, r12 */
    mov.l @r15+, r0
    jsr @r12
    mov r6, r1
    mov r0, r6
    ...
    mov.l @(r0, r7), r6
    .byte   0xD5, 0x08    /* mov.l .L_pool_0602D3F0, r5 */
    cmp/ge r6, r5
    bt      .L_0602D3FC
    neg r5, r5
    cmp/gt r6, r5
...
.L_0602D414:
    ...
    mov.l @(r0, r7), r6
    .byte   0xD3, 0x07    /* mov.l .L_pool_0602D438, r3 */
    cmp/ge r6, r3
    bt      .L_0602D424
    neg r3, r3
    cmp/ge r6, r3
