...
display_hw_init:
    sts.l pr, @-r15
    mov.l   .L_pool_fn_param_reset, r3
    jsr @r3
    nop
    mov.l   .L_pool_view_offset_a, r5
    mov #0x0, r4
    mov.l r4, @r5
    extu.w r4, r0
    extu.w r4, r3
    mov.l r4, @(4, r5)
    mov.l   .L_pool_view_offset_b, r5
    mov.l r4, @r5
    mov.l r4, @(4, r5)
    mov.l   .L_pool_color_accum, r5
    mov.l r4, @r5
    mov.l r4, @(4, r5)
    mov.l   .L_pool_scene_pending, r5
    mov.w r4, @r5
    mov.w r0, @(2, r5)
    extu.w r4, r0
    mov.l   .L_pool_scene_render, r5
    mov.w r3, @r5
    mov.w r0, @(2, r5)
    mov r4, r3
    mov.l   .L_pool_scene_src_a, r5
    mov r3, r2
    mov.l r4, @r5
    mov.l r3, @(4, r5)
    mov.l   .L_pool_scene_dirty, r5
    mov.l r2, @r5
    mov.l   .L_pool_fn_init_chain, r3
    jsr @r3
    mov.l r2, @(4, r5)
