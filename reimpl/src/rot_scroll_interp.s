...
rot_scroll_interp:
    ...
    mov.l r5, @(56, r0)
    mov.l r6, @(60, r0)
    .byte   0xD0, 0x0D    /* mov.l .L_pool_0602E4AC, r0 */
    jsr @r0
    nop
    mov r0, r8
    mov r7, r4
    .byte   0xD0, 0x0C    /* mov.l .L_pool_0602E4B0, r0 */
    jsr @r0
    nop
    dmuls.l r0, r3
    mov r14, r0
    .byte   0xDA, 0x0A    /* mov.l .L_pool_0602E4B4, r10 */
    sts mach, r11
    sts macl, r3
    xtrct r11, r3
    mov.l r3, @(r0, r10)
    ...
    mov.l r5, @(16, r0)
    dmuls.l r8, r9
    .byte   0xDA, 0x07    /* mov.l .L_pool_0602E4B8, r10 */
    sts mach, r8
    sts macl, r9
    xtrct r8, r9
    mov.l r9, @(r0, r10)
