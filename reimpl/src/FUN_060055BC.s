...
.L_060055FE:
    ...
    mov #0x0, r5
    mov r13, r4
    .reloc ., R_SH_IND12W, FUN_0600553C - 4
    .2byte 0xB000    /* bsr FUN_0600553C (linker-resolved) */
    add #0x2, r4
    mov r15, r5
    mov r13, r4
...
.L_060056B0:
    ...
    add #0x4, r5
    .reloc ., R_SH_IND12W, FUN_06005294 - 4
    .2byte 0xB000    /* bsr FUN_06005294 (linker-resolved) */
    add #0x10, r4
