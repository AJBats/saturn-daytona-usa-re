...
replay_cam_auto_cut:
    ...
    sts.l pr, @-r15
    add #-0x4, r15
    .byte   0xD3, 0x13    /* mov.l .L_p_course_dlist_desc, r3 */
    mov.l r3, @r15
    mov r3, r7
    mov.w   .L_w_dlist_src_offset, r6
    mov.l @r15, r5
    mov.l @(4, r7), r7
    .byte   0xD3, 0x11    /* mov.l .L_dlist_offset_0xC000, r3 */
    mov.l @r5, r5
    add r3, r7
    .byte   0xD3, 0x11    /* mov.l .L_p_display_list_loader, r3 */
    jsr @r3
    mov #0x8, r4
    .byte   0xDE, 0x10    /* mov.l .L_p_attract_frame_ctr, r14 */
    .byte   0xD5, 0x11    /* mov.l .L_p_render_state, r5 */
    .byte   0xD4, 0x11    /* mov.l .L_p_race_end_state, r4 */
    mov.b @r14, r6
    mov.l @r5, r5
    mov.l @r4, r4
    exts.b r5, r5
    ...
    add #0x5, r2
    mov.b r2, @r14
    .byte   0xD2, 0x05    /* mov.l .L_p_phase_countdown, r2 */
    mov.b r3, @r2
    .byte   0xD4, 0x05    /* mov.l .L_p_phase_index, r4 */
    mov.b @r4, r3
    add #0x1, r3
    mov.b r3, @r4
    add #0x4, r15
