...
palette_fade_calc:
    mov.l r14, @-r15
    mov.l   .L_pool_car_array_base, r9
    mov.l @r9, r9
    mov.l   .L_pool_current_pal_offset, r0
    mov.l @(r0, r9), r7
    mov.l   .L_pool_target_pal_offset, r0
    mov.l @(r0, r9), r10
    mov.l   .L_pool_scroll_param_a, r3
    mov.l @r3, r3
    cmp/eq r10, r3
    bf      .L_check_param_b
...
.L_pool_scroll_param_a:
    .4byte  DAT_06083264
.L_check_param_b:
    mov.l   .L_pool_scroll_param_b, r3
    mov.l @r3, r3
    cmp/eq r10, r3
