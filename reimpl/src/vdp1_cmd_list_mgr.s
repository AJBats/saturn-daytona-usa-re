...
.L_0602CF22:
    sub r6, r7
    mov.w   .L_const_0x252_w, r1
    mov.w @(r0, r1), r2
    mov #0x1, r4
    cmp/eq r4, r2
    bt      .L_0602CF40
    mov.l   .L_offset_0x02c, r3
    bra     .L_0602CF44
    mov.l r7, @(r0, r3)
.L_const_0x252_w:
    .2byte  0x0252
...
.L_0602CFFC:
    ...
    mov.l @(r0, r2), r5
    sub r5, r4
    mov.w   .L_const_0x258_w, r6
    mov.w   .L_const_0x0444_w, r8
    cmp/gt r8, r4
    bt      .L_0602D02C
    neg r8, r8
    cmp/ge r4, r8
...
vdp1_sprite_cmd:
    ...
    cmp/pl r7
    bt      .L_0602D0EC
    mov.w   .L_const_0x2e0_w, r3
    mov.l   .L_offset_0x300, r5
    mov.l @(8, r0), r7
