...
track_segment_advance:
    sts.l pr, @-r15
    .byte   0xD4, 0x22    /* mov.l .L_pool_0600CF48, r4 */
    mov.w   DAT_0600cf3a, r0
    .byte   0xD3, 0x20    /* mov.l .L_pool_0600CF44, r3 */
    mov.l @r4, r4
    mov.l @r3, r3
    mov.l @(r0, r4), r5
    add #0x68, r0
    ...
    .byte   0xD3, 0x1A    /* mov.l .L_pool_0600CF4C, r3 */
    add r4, r1
    add r4, r2
    jsr @r3
    mov #0x2, r0
    mov r5, r2
    .byte   0xD3, 0x17    /* mov.l .L_pool_0600CF4C, r3 */
    ...
    cmp/pl r5
    bf      .L_0600CF34
    .byte   0xD2, 0x11    /* mov.l .L_pool_0600CF50, r2 */
    mov.l @r2, r2
    add #-0x10, r2
    cmp/gt r2, r5
    bf      .L_0600CF34
    ...
    add #-0xC, r0
    mov.l r2, @(r0, r4)
    .byte   0xD5, 0x0C    /* mov.l .L_pool_0600CF54, r5 */
    mov.l @r5, r3
    add #0x10, r0
    mov.l @(r0, r4), r2
    sub r2, r3
