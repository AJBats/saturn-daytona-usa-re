...
.L_pool_06013818:
    .4byte  sym_06084B08
.L_0601381C:
    .byte   0xD3, 0x2F    /* mov.l .L_pool_060138DC, r3 */
    mov.l r4, @r3
    mov #0x0, r2
    .byte   0xD3, 0x2F    /* mov.l .L_pool_060138E0, r3 */
    mov.l r2, @r3
    mov #0x50, r2
    .byte   0xD3, 0x2E    /* mov.l .L_pool_060138E4, r3 */
    mov.l r2, @r3
    .byte   0x92, 0x53    /* mov.w .L_wpool_060138D6, r2 */
    .byte   0xD3, 0x2E    /* mov.l .L_pool_060138E8, r3 */
    mov.w r2, @r3
    .byte   0x92, 0x51    /* mov.w .L_wpool_060138D8, r2 */
    .byte   0xD3, 0x2D    /* mov.l .L_pool_060138EC, r3 */
    mov.l r2, @r3
    mov #0x0, r5
    extu.b r5, r2
    .byte   0xD3, 0x2C    /* mov.l .L_pool_060138F0, r3 */
    mov.b r2, @r3
    .byte   0xD4, 0x2C    /* mov.l .L_pool_060138F4, r4 */
    extu.b r5, r3
    mov.b r3, @r4
    add #0x1, r4
    extu.b r5, r3
    ...
    mov.l @r6, r4
    shll2 r4
    .byte   0xD3, 0x26    /* mov.l .L_pool_060138F8, r3 */
    .byte   0xD1, 0x27    /* mov.l .L_pool_060138FC, r1 */
    shll2 r4
    shll r4
    add r3, r4
    mov.w @(24, r4), r0
    ...
    mov #0x0, r1
    mov.l @r4, r3
    .byte   0x92, 0x33    /* mov.w .L_wpool_060138DA, r2 */
    add r2, r3
    .byte   0xD2, 0x22    /* mov.l .L_pool_06013900, r2 */
    mov.l r3, @r2
    .byte   0xD2, 0x22    /* mov.l .L_pool_06013904, r2 */
    mov.w r1, @r2
    .byte   0xD5, 0x22    /* mov.l .L_pool_06013908, r5 */
    .byte   0xD2, 0x23    /* mov.l .L_pool_0601390C, r2 */
    jsr @r2
    mov r1, r4
    .byte   0xD3, 0x22    /* mov.l .L_pool_06013910, r3 */
    jsr @r3
    nop
    add #0x8, r15
    lds.l @r15+, pr
    ...
    mov.l @r15+, r12
    mov.l @r15+, r13
    .byte   0xD3, 0x1E    /* mov.l .L_pool_06013914, r3 */
    jmp @r3
    mov.l @r15+, r14
