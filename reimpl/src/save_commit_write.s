...
.L_0603BF44:
    ...
    add #0x4, r15
    lds.l @r15+, pr
    .byte   0xD3, 0x08    /* mov.l .L_pool_0603BF70, r3 */
    jmp @r3
    mov.l @r15+, r14
    .2byte  0x7F04
    .4byte  0x4F26000B
...
sym_0603BF7C:
    ...
    mov #0x3F, r9
    mov #0x40, r10
    .byte   0xDB, 0x1C    /* mov.l .L_pool_0603BFFC, r11 */
...
sym_0603C000:
    ...
    .byte   0xDD, 0x1C    /* mov.l .L_pool_0603C080, r13 */
    mov #0x0, r7
...
.L_0603C032:
    ...
    .global sym_0603C05C
sym_0603C05C:
    .byte   0xD3, 0x09    /* mov.l .L_pool_0603C084, r3 */
    .byte   0xD2, 0x0A    /* mov.l .L_fp_0x4000_0000, r2 */
    and r3, r4
    or r2, r4
    mov r4, r7
    add r5, r7
