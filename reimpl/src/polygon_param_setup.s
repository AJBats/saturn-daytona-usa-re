...
.L_0603933A:
    extu.w r5, r4
    mov.l   .L_pool_060393A4, r3
    shll2 r4
    add r3, r4
    mov.w @r4, r2
    mov.l   .L_pool_060393A8, r3
    mov.l r2, @r3
    mov.w @(2, r4), r0
    mov r0, r2
    mov.l r0, @r14
...
.L_06039366:
    mov #0x1, r3
    mov.l   .L_pool_060393AC, r2
    mov.w r3, @r2
    bra     .L_06039376
    nop
.L_06039370:
    extu.w r7, r2
    mov.l   .L_pool_060393AC, r3
    mov.w r2, @r3
.L_06039376:
    extu.w r6, r6
    tst r6, r6
    bt      .L_06039386
    mov #0x8, r3
    mov.l   .L_pool_060393B0, r2
    mov.w r3, @r2
    bra     .L_0603938C
    nop
.L_06039386:
    extu.w r7, r2
    mov.l   .L_pool_060393B0, r3
    mov.w r2, @r3
.L_0603938C:
    extu.w r7, r2
    mov.l   .L_pool_060393B4, r3
    mov.w r2, @r3
    rts
    mov.l @r15+, r14
    .2byte  0xFFFF
...
sym_060393FC:
    mov.w @(2, r15), r0
    mov.l   .L_pool_06039438, r3
    mov r0, r1
    mov.w r4, @r3
    mov.l   .L_pool_0603943C, r3
    mov.w r5, @r3
    mov.l   .L_pool_06039440, r3
    mov.w r6, @r3
    mov.l   .L_pool_06039444, r3
    mov.w r7, @r3
...
.L_060394F0:
    ...
    bt      .L_060394FE
    mov #0x10, r3
    mov.l   .L_pool_06039508, r2
    mov.w r3, @r2
    bra     .L_06039504
    nop
.L_060394FE:
    mov #0x0, r2
    mov.l   .L_pool_06039508, r3
    mov.w r2, @r3
.L_06039504:
    rts
    nop
