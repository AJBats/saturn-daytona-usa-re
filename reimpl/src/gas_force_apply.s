...
.L_pool_06008374:
    .4byte  sym_060453CC
.L_06008378:
    mov.l   .L_pool_06008408, r2
    mov.w   .L_wpool_060083FA, r3
    mov.l @r2, r2
    cmp/gt r3, r2
    bf      .L_060083DE
    mov.l   .L_pool_0600840C, r3
...
race_config_physics:
    ...
    tst r3, r3
    bt      .L_06008558
    mov.l   .L_pool_06008574, r0
    mov.b @r0, r0
    extu.b r0, r0
    tst r0, r0
    bf      .L_0600850E
    mov.l   .L_pool_06008578, r0
    mov.w @r0, r0
    extu.w r0, r0
    tst r0, r0
    bf      .L_06008558
.L_0600850E:
    mov #0x3, r3
    mov.l   .L_pool_0600857C, r2
    mov #0x0, r5
    mov.w r3, @r2
    mov #0x7, r3
    mov.l   .L_pool_06008580, r2
    mov.b r3, @r2
    mov #0x2, r3
    mov.l   .L_pool_06008584, r2
    mov.l r3, @r2
    mov #0x1, r3
    mov.l   .L_pool_06008588, r2
    mov.l r3, @r2
    mov.l   .L_pool_0600858C, r3
    jsr @r3
    mov #0x8, r4
    mov.l   .L_pool_06008590, r2
    mov.l   .L_pool_06008594, r3
    mov.l r2, @r3
    mov.l   .L_pool_06008598, r2
    mov.l   .L_pool_0600859C, r3
    mov.l r2, @r3
    ...
    mov.l r2, @r3
    mov #0x0, r2
    mov.l   .L_pool_060085B0, r3
    mov.l r2, @r3
    mov.l @r14, r2
    mov.w   .L_wpool_06008560, r0
    mov.l @(r0, r2), r3
    exts.b r3, r3
    mov.l   .L_pool_060085B4, r2
    mov.b r3, @r2
.L_06008558:
    lds.l @r15+, pr
    rts
