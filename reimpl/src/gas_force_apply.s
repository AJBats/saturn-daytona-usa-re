...
.L_060082D4:
    ...
    tst r5, r5
    bt      .L_060082FC
    mov.l   .L_fp_neg_20974_e401_2, r5
...
.L_060083DE:
    mov #0x0, r5
    mov.l @r4, r2
    mov.w   .L_const_0x301_w_2, r1
    mov.l   .L_sym_06034F78_2, r3
    jsr @r3
    mov r5, r0
    mov.l @r4, r2
    mov.w   .L_const_0x201_w_2, r1
    mov.l   .L_sym_06034F78_2, r3
    jsr @r3
    mov r5, r0
    lds.l @r15+, pr
