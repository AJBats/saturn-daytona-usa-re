...
course_data_loader:
    ...
    mov.l   .L_pal_course_main, r5
    mov.l   .L_vdp2_cram_0x6C0, r4
    jsr @r14
    mov #0x60, r6
    mov.l   .L_pal_course_ext_a, r5
    mov.l   .L_vdp2_cram_0x720, r4
    jsr @r14
    mov #0x20, r6
    mov.l   .L_pal_course_ext_b, r5
    mov.l   .L_vdp2_cram_0x740, r4
    jsr @r14
    mov #0x20, r6
    mov.w   .L_cram_full_size, r6
    mov.l   .L_pal_full_init, r5
    mov.l   .L_vdp2_cram_0x000, r4
    mov.l   .L_fn_dma_transfer, r3
    jsr @r3
    nop
    mov.l   .L_fn_disp_chan_cfg, r3
    jsr @r3
    mov #0xC, r4
    mov.l   .L_fn_disp_chan_init, r3
    jsr @r3
    nop
