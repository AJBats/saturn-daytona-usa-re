...
vram_defrag:
    sts.l pr, @-r15
    sts.l macl, @-r15
    mov.w   .L_wpool_car_struct_stride, r8
    mov.l   .L_pool_iter_counter_ptr, r11
    mov.l   .L_pool_entry_count_ptr, r12
    mov r8, r10
    mov.w @r12, r14
    add #-0x68, r10
    extu.w r14, r14
    shll2 r14
    shll r14
    mov.l   .L_pool_vram_block_ptr, r3
    mov.l @r3, r3
    bra     .L_loop_test
    add r3, r14
.L_process_entry:
    ...
    extu.w r2, r2
    shll2 r2
    mov.l   .L_pool_lookup_table_ptr, r3
    mov.l @r3, r3
    add r3, r2
    mov.l @r2, r1
    mov.l   .L_pool_vram_dest_addr, r0
    mov.l r1, @r0
    extu.w r9, r2
    mov.l   .L_pool_handler_mode_ptr, r1
    mov.w r2, @r1
    bra     .L_loop_done
    nop
.L_alloc_path:
    mov.w @(2, r14), r0
    mov.l   .L_pool_car_array_base, r3
    mov.w   .L_wpool_car_result_offset, r4
    mov r0, r13
    mul.l r8, r13
    mov.w @(4, r14), r0
    sts macl, r13
    ...
    add r3, r13
    extu.w r5, r5
    mov.l   .L_pool_fpmul_addr, r3
    jsr @r3
    shll16 r5
    mov.w   .L_wpool_car_fpmul_dest_offset, r1
    add r13, r1
    mov.l r0, @r1
    mov.w @(6, r14), r0
    mov r0, r3
    extu.w r3, r3
    mov.w   .L_wpool_car_size_attr_offset, r0
    mov.l r3, @(r0, r13)
    add #0xC, r0
    mov.l r10, @(r0, r13)
    mov.w @r12, r3
...
.L_pool_game_state_ptr:
    ...
    .global loc_06020090
loc_06020090:
    mov.l   .L_pool_game_state_ptr_b, r0
    mov.l @r0, r0
    cmp/eq #0x17, r0
