 ...
 *
 * Dispatches a HUD sound effect via sound_cmd_dispatch based on
 * display state. Two paths:
 *
...
hud_element_draw:
    ...
    .4byte  0x06FC0200                  ! (embedded data - unreferenced pool padding)
    .4byte  0x00E100E2                  ! (embedded data)
    .4byte  0x009007A2                  ! (embedded data)
...
.L_call_sound_dispatch:
    jsr @r14                            ! call sound_cmd_dispatch(r4, r5)
