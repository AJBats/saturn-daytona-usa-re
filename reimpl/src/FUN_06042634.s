...
FUN_060425E8:
    ...
    .global FUN_060425FA
    .type FUN_060425FA, @function
FUN_060425FA:

    sts.l pr, @-r15
    mov.l   .L_pool_06042707, r11
...
.L_06042658:
    ...
    cmp/ge r2, r5
    bt      .L_06042664
    mov.l   .L_pool_0604270B, r13
    bra     .L_06042674
    nop

.L_06042664:
    mov.l   .L_pool_06042703, r0
    swap.w r4, r2
    mov.l r5, @r0
    exts.w r2, r2
    mov.l r2, @(16, r0)
...
.L_060426A4:
    ...
    mov.l   .L_pool_0604270F, r2
    cmp/gt r2, r4
    bf      .L_060426C4
    mov.l   .L_pool_0604270F, r4
...
.L_060426D0:
    ...
    mov.l   .L_pool_06042713, r2
    bra     .L_060426E0
    nop

.L_060426DE:
    mov.l   .L_pool_06042717, r2
