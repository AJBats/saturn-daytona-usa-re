...
geom_math_calc:
    ...
    .byte   0xDC, 0x2C    /* mov.l .L_pool_06018224, r12 */
    .byte   0xDD, 0x2D    /* mov.l .L_pool_06018228, r13 */
    .byte   0xDE, 0x2D    /* mov.l .L_pool_0601822C, r14 */
    .byte   0xD4, 0x2E    /* mov.l .L_pool_06018230, r4 */
    mov.w @r12, r3
    mov.l @r4, r4
    add #0x1, r3
    mov.w r3, @r12
    .byte   0xD2, 0x2C    /* mov.l .L_pool_06018234, r2 */
    ...
    cmp/hs r2, r3
    bf      .L_06018196
    .byte   0xD4, 0x2A    /* mov.l .L_pool_06018238, r4 */
    mov.l @r4, r4
    bra     .L_0601819C
    mov #0x1, r5
.L_06018196:
    .byte   0xD4, 0x29    /* mov.l .L_pool_0601823C, r4 */
    mov.l @r4, r4
    mov #0x0, r5
.L_0601819C:
...
.L_060181D2:
    ...
    shll r2
    add r13, r2
    .byte   0xD3, 0x14    /* mov.l .L_pool_06018240, r3 */
    mov.l @r3, r3
    mov.l r3, @r2
    mov #0x0, r2
    mov.w r2, @r12
