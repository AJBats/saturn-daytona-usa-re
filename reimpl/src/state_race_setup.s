...
state_race_setup:
    ...
    bf      .L_06008F82              /* no → skip course auto-select */
    mov.l   .L_special_mode_flag, r0
    mov.l @r0, r0
    tst r0, r0
    bf      .L_06008F82              /* special mode active → skip */
    mov.l   .L_overlay_active, r0
    mov.b @r0, r0
    tst r0, r0
    bf      .L_06008F82              /* overlay active → skip */
    mov.l   .L_status_word, r4       /* --- course selection from status bits --- */
    ...
    and r2, r3
    tst r3, r3
    bt      .L_06008F12              /* mask A clear → check mask B */
    bra     .L_06008F82              /* mask A set → course 0 (default) */
...
.L_06008F12:
    ...
    and r3, r2
    tst r2, r2
    bt      .L_06008F26              /* mask B clear → check mask C */
    exts.b r6, r6
    bra     .L_06008F82
...
.L_06008F26:
    ...
    and r3, r2
    tst r2, r2
    bt      .L_06008F70              /* mask C clear → check mask D */
    mov #0x2, r3
...
.L_06008F70:                              /* --- check course mask D --- */
    exts.w r4, r4
    ...
    and r2, r4
    tst r4, r4
    bt      .L_06008F82              /* mask D clear → no auto-select */
    exts.b r13, r3
    mov.b r3, @r5                    /* course_index = 3 */
.L_06008F82:                              /* === Subsystem initialization === */
    ...
    extu.b r0, r0
    tst r0, r0
    bf      .L_06008FAC              /* result != 0 → keep mode 3 */
    mov.l   .L_mode_register, r0
    mov.w @r0, r0
    extu.w r0, r0
    tst r0, r0
    bt      .L_06008FAC              /* mode register == 0 → keep mode 3 */
    mov #0x4, r3
    mov.b r3, @r4                     /* sound_mode = 4 (enhanced) */
.L_06008FAC:                              /* --- race master init --- */
    ...
    mov.l   .L_race_end_state, r4    /* --- variant setup dispatch --- */
    ...
    mov.b @r0, r0
    tst r0, r0
    bt      .L_06008FFE              /* overlay not active → skip */
    mov.l   .L_fn_menu_overlay, r3
    jsr @r3                            /* menu_overlay_render(1) */
    mov #0x1, r4
.L_06008FFE:                              /* --- final state setup --- */
