...
FUN_06013B04:
    ...
    add #0x1, r3
    mov.w r3, @r14
    .byte   0xB1, 0x8F    /* bsr FUN_06013E3C */
    nop
    .byte   0xB3, 0x25    /* bsr FUN_0601416C */
    nop
    mov.w @r14, r4
    extu.w r4, r4
    add #-0x1F, r4
...
.L_06013C36:
    extu.w r3, r3
    mov.w r3, @r5
    .byte   0xB1, 0xC3    /* bsr FUN_06013FC4 (external) */
    nop
    .byte   0xA2, 0x95    /* bra FUN_0601416C (external */
    lds.l @r15+, pr
    .2byte  0xFFFF
.L_pool_06013C44:
    .4byte  sym_06084B14
