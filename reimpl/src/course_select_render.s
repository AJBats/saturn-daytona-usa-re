/* course_select_render -- L3 assembly (SH-2 mnemonics)
...
.L_06019798:
    mov.w @(2, r4), r0
    .byte   0x93, 0x63    /* mov.w .L_wpool_06019864, r3 */
    mov r0, r2
    extu.w r2, r2
    and r3, r2
    tst r2, r2
    ...
    mov.b r3, @r14
.L_060197BC:
    .byte   0xD4, 0x2B    /* mov.l .L_pool_0601986C, r4 */
    mov.b @r4, r2
    add #0x1, r2
    mov.b r2, @r4
    mov.b @r12, r3
    ...
    mov.b @r14, r2
    shll2 r2
    .byte   0xD3, 0x28    /* mov.l .L_pool_06019870, r3 */
    add r3, r2
    mov.l @r2, r2
    add #0xC, r15
    lds.l @r15+, pr
