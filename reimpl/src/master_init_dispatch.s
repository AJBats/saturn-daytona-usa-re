 ...
 *
 * Primary SH-2 initialization dispatcher. Sets up initial game state
 * (heap pointer, mode flags, dispatch flags) then registers ~100+
 * callback handlers into various jump tables via repeated calls to
 * obj_transform_cache (r4=table_base, r5=entry_size, r6=handler_addr,
 * r7=slot_id). Also uses sym_0600508A for memory-clear (memset-like)
 * operations on large data regions.
 *
 * Registration phases:
 *   Phase 1 (0x3A3C): State init + handler_table_a/b/c/d/e/f/g/h
 *   Phase 2 (0x3B48): Object table init + null slot reservations
 *   Phase 3 (0x3C70): Scene table registrations
 *   Phase 4 (0x3D94): GFX table registrations (mostly null slots)
 *   Phase 5 (0x3EB8): Misc table + memset clears + extra handlers
 *   Phase 6 (0x3FDC): Physics table + more memset clears
 *   Phase 7 (0x4100): Final memset batch (large raw .4byte region)
 */
...
master_init_dispatch:
    ...
    mov #0x0, r3                 ! --- begin state initialization ---
    mov.l   .L_game_state_flag, r2
    mov.l r3, @r2                ! game_state = 0
    mov.l   .L_heap_base_addr, r3
    mov.l   .L_heap_base_ptr, r2
    mov.l r3, @r2                ! heap_base_ptr = 0x060F0000
    mov #0x0, r3
    mov.l   .L_init_mode_flag, r2
    mov.l r3, @r2                ! init_mode = 0
    mov.w   .L_const_0080, r3
    mov.l   .L_dispatch_flags, r2
    mov.l r3, @r2                ! dispatch_flags = 0x80
    mov #0x1, r3
    mov.l   .L_init_counter, r2
    mov.l r3, @r2                ! init_counter = 1
    mov.w   DAT_06003ade, r7      ! --- begin handler registration ---
    mov.l   .L_handler_slot_96, r6  ! r7=0x96 slot, r6=handler addr
    mov.l   .L_handler_table_a, r4  ! r4=table base (sym_06059EC8)
    mov.l   .L_fn_register_handler, r3
    jsr @r3                      ! register(table, stride=8, handler, slot)
    mov #0x8, r5
    ...
    jsr @r3
    mov #0x9, r5
    mov #0x0, r7                 ! null handler, slot 0
    mov r7, r6
    bra     .L_register_obj_handlers  ! continue to phase 2
    mov #0x8, r5
.L_const_0080:
    .2byte  0x0080
...
.L_handler_table_h:
    .4byte  sym_060EE300
.L_register_obj_handlers:            ! --- Phase 2: object table init ---
    mov.l   .L_obj_table_init_a, r4  ! init table at sym_060EE7D4
    mov.l   .L_fn_register_handler_2, r3
    jsr @r3                      ! table_init(table_base)
    nop
    mov #0x0, r7
...
.L_handler_table_a_2:
    .4byte  sym_06059EC8
.L_register_scene_handlers:          ! --- Phase 3: scene table handlers ---
    mov.l   .L_handler_slot_13c, r6  ! r7=0x13C (from DAT_06003c1a)
    mov.l   .L_handler_table_a_3, r4
    mov.l   .L_fn_register_handler_3, r3
    jsr @r3                      ! register(table_a, stride=9, handler, slot)
    mov #0x9, r5
    mov #0x19, r7
...
.L_scene_table_52:
    .4byte  0x002BE684
.L_register_gfx_handlers:            ! --- Phase 4: GFX table init ---
    mov.l   .L_gfx_table_init, r4   ! init GFX handler table
    mov.l   .L_fn_register_handler_4, r3
    jsr @r3                      ! table_init(gfx_table)
    nop
    mov #0x0, r7
...
.L_gfx_table_null_16:
    .4byte  0x002B4CAC
.L_register_misc_handlers:           ! --- Phase 5: misc table + memset ---
    mov.l   .L_fn_register_handler_5, r3
    jsr @r3                      ! table_init (r4 from prev phase tail)
    nop
    mov #0x0, r7
    ...
    jsr @r3
    mov #0x8, r5
    mov.w   .L_memset_size_0a00, r5  ! size=0x0A00 bytes
    mov.l   .L_memset_target_01, r4  ! clear data region 1
    mov.l   .L_fn_register_memset, r3
    jsr @r3                      ! memset(target, fill=4, size)
    mov #0x4, r6
...
.L_misc_table_null_07:
    .4byte  0x002BE80C
.L_register_phys_handlers:           ! --- Phase 6: physics table handlers ---
    mov.l   .L_handler_slot_07, r6  ! r7=0x7 (from prev phase tail)
    mov.l   .L_phys_table_07, r4
    mov.l   .L_fn_register_handler_6, r3
    jsr @r3                      ! register(phys_table, stride=4, handler, slot)
    mov #0x4, r5
    mov #0x26, r7
...
.L_memset_target_11:
    .4byte  0x002BDC50
.L_register_final_batch:             ! --- Phase 7: final memset + raw blob ---
    mov.l   .L_final_memset_target, r4
    mov.l   .L_fn_register_memset_3, r3
    jsr @r3                      ! memset first region
    nop
    mov.w   DAT_060041c2, r5     ! size=0x0D7D
    mov.l   .L_final_memset_batch, r4  ! bulk memset batch (continues as raw .4byte)
    .4byte  0xD32F430B
    .4byte  0xE6049556
    .4byte  0xD42FD32D
    .4byte  0x430BE604
