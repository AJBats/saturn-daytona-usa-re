 ...
 * ================================================================ */
#if 0 /* FUN_0600F822 -- replaced by ASM import */
...
/* FUN_0600F822 -- original binary (78 bytes) */
__asm__(
    ".section .text.FUN_0600F822, \"ax\"\n"
    ".balign 2\n"
    ".global _FUN_0600F822\n"
    ".global _FUN_0600f822\n"
    ".type _FUN_0600F822, @function\n"
    "_FUN_0600F822:\n"
    "_FUN_0600f822:\n"
    ".byte 0x4F, 0x22, 0xD5, 0x0C, 0xD3, 0x0D, 0x43, 0x0B, 0xE4, 0x00, 0xD3, 0x0C, 0x43, 0x0B, 0xE4, 0x00\n"  /* 0x0600F822 */
    ".byte 0xD3, 0x0C, 0x43, 0x0B, 0x00, 0x09, 0xE2, 0x78, 0xD3, 0x0B, 0x23, 0x21, 0xE2, 0x03, 0xD3, 0x0A\n"  /* 0x0600F832 */
    ".byte 0x4F, 0x26, 0x00, 0x0B, 0x23, 0x20, 0x08, 0x00, 0xFF, 0xFF, 0x06, 0x08, 0x5F, 0xF4, 0x06, 0x06\n"  /* 0x0600F842 */
    ".byte 0x3D, 0x98, 0x06, 0x07, 0x86, 0x63, 0xAB, 0x11, 0x01, 0xFF, 0x06, 0x01, 0xD5, 0xF4, 0x06, 0x01\n"  /* 0x0600F852 */
    ".byte 0x14, 0xAC, 0x06, 0x01, 0x10, 0x94, 0x06, 0x07, 0x88, 0x7C, 0x06, 0x07, 0x88, 0x7F\n"  /* 0x0600F862 */
);
 ...
 * ================================================================ */
#if 0 /* FUN_0600F8BE -- replaced by ASM import */
...
/* FUN_0600F8BE -- original binary (86 bytes) */
__asm__(
    ".section .text.FUN_0600F8BE, \"ax\"\n"
    ".balign 2\n"
    ".global _FUN_0600F8BE\n"
    ".global _FUN_0600f8be\n"
    ".type _FUN_0600F8BE, @function\n"
    "_FUN_0600F8BE:\n"
    "_FUN_0600f8be:\n"
    ".byte 0x4F, 0x22, 0xD4, 0x07, 0x63, 0x41, 0x73, 0xFF, 0x24, 0x31, 0x63, 0x3F, 0x43, 0x15, 0x8B, 0x14\n"  /* 0x0600F8BE */
    ".byte 0xD3, 0x09, 0x43, 0x2B, 0x4F, 0x26, 0x07, 0x08, 0xFF, 0xFF, 0x06, 0x01, 0x14, 0xAC, 0x06, 0x01\n"  /* 0x0600F8CE */
    ".byte 0x10, 0x94, 0x06, 0x07, 0x88, 0x7C, 0x06, 0x07, 0x88, 0x7F, 0x06, 0x02, 0x85, 0x60, 0x06, 0x07\n"  /* 0x0600F8DE */
    ".byte 0xEB, 0xCC, 0x06, 0x07, 0x88, 0x6E, 0x06, 0x01, 0x15, 0xF0, 0xD3, 0x19, 0x43, 0x0B, 0xE4, 0x04\n"  /* 0x0600F8EE */
    ".byte 0xD4, 0x19, 0x4F, 0x26, 0x62, 0x40, 0x72, 0x01, 0x00, 0x0B, 0x24, 0x20, 0xD4, 0x16, 0x63, 0x40\n"  /* 0x0600F8FE */
    ".byte 0x73, 0x01, 0x00, 0x0B, 0x24, 0x30\n"  /* 0x0600F90E */
);
 ...
 * ================================================================ */
#if 0 /* FUN_0600F914 -- replaced by ASM import */
...
/* FUN_0600F914 -- original binary (120 bytes) */
__asm__(
    ".section .text.FUN_0600F914, \"ax\"\n"
    ".balign 2\n"
    ".global _FUN_0600F914\n"
    ".global _FUN_0600f914\n"
    ".type _FUN_0600F914, @function\n"
    "_FUN_0600F914:\n"
    "_FUN_0600f914:\n"
    ".byte 0x2F, 0xE6, 0x4F, 0x22, 0xD3, 0x13, 0x43, 0x0B, 0x00, 0x09, 0xD3, 0x13, 0x43, 0x0B, 0x00, 0x09\n"  /* 0x0600F914 */
    ".byte 0xEE, 0x00, 0xD3, 0x12, 0x62, 0xED, 0x66, 0xE3, 0x23, 0x21, 0xE3, 0x02, 0xD1, 0x10, 0x21, 0x31\n"  /* 0x0600F924 */
    ".byte 0xD2, 0x10, 0xD3, 0x11, 0x23, 0x22, 0x65, 0x33, 0x65, 0x52, 0xD3, 0x10, 0x43, 0x0B, 0xE4, 0x10\n"  /* 0x0600F934 */
    ".byte 0xD3, 0x0F, 0x43, 0x0B, 0x00, 0x09, 0xE2, 0x07, 0xD3, 0x05, 0x23, 0x20, 0xD3, 0x07, 0x23, 0xE1\n"  /* 0x0600F944 */
    ".byte 0x64, 0xED, 0x4F, 0x26, 0xD3, 0x0B, 0x43, 0x2B, 0x6E, 0xF6, 0xFF, 0xFF, 0x06, 0x02, 0x85, 0x3E\n"  /* 0x0600F954 */
    ".byte 0x06, 0x07, 0x88, 0x7F, 0x06, 0x01, 0x16, 0x78, 0x06, 0x01, 0x20, 0x80, 0x06, 0x07, 0x88, 0x6E\n"  /* 0x0600F964 */
    ".byte 0x06, 0x05, 0xAA, 0xA2, 0xFE, 0xA0, 0x00, 0x00, 0x06, 0x07, 0x88, 0x5C, 0x06, 0x01, 0x48, 0x84\n"  /* 0x0600F974 */
    ".byte 0x06, 0x01, 0x14, 0x50, 0x06, 0x01, 0x15, 0x5E\n"  /* 0x0600F984 */
);
 ...
 * ================================================================ */
#if 0 /* FUN_0600FE38 -- replaced by ASM import */
...
/* FUN_0600FE38 -- original binary (152 bytes) */
__asm__(
    ".section .text.FUN_0600FE38, \"ax\"\n"
    ".balign 2\n"
    ".global _FUN_0600FE38\n"
    ".global _FUN_0600fe38\n"
    ".type _FUN_0600FE38, @function\n"
    "_FUN_0600FE38:\n"
    "_FUN_0600fe38:\n"
    ".byte 0x4F, 0x22, 0x7F, 0xFC, 0xD4, 0x16, 0x63, 0x42, 0x73, 0xFF, 0x24, 0x32, 0x92, 0x25, 0x33, 0x20\n"  /* 0x0600FE38 */
    ".byte 0x8B, 0x14, 0xD2, 0x14, 0x2F, 0x22, 0xD4, 0x14, 0xD3, 0x14, 0x43, 0x0B, 0x65, 0x23, 0xD7, 0x14\n"  /* 0x0600FE48 */
    ".byte 0xE6, 0x00, 0x65, 0xF2, 0xD3, 0x13, 0x57, 0x71, 0x37, 0x3C, 0xD3, 0x13, 0x43, 0x0B, 0xE4, 0x04\n"  /* 0x0600FE58 */
    ".byte 0xE2, 0x00, 0xD3, 0x12, 0x23, 0x22, 0xE2, 0x10, 0xD3, 0x11, 0x23, 0x20, 0xD7, 0x11, 0x96, 0x0D\n"  /* 0x0600FE68 */
    ".byte 0x95, 0x0D, 0xD3, 0x11, 0x43, 0x0B, 0xE4, 0x0C, 0xD4, 0x10, 0xD3, 0x11, 0x43, 0x0B, 0x00, 0x09\n"  /* 0x0600FE78 */
    ".byte 0xD4, 0x10, 0x7F, 0x04, 0xD3, 0x0E, 0x43, 0x2B, 0x4F, 0x26, 0x00, 0xAB, 0x00, 0x90, 0x07, 0xA2\n"  /* 0x0600FE88 */
    ".byte 0x06, 0x07, 0xEB, 0xCC, 0x06, 0x09, 0x4F, 0xA8, 0x06, 0x0E, 0xFB, 0x24, 0x06, 0x02, 0x86, 0x54\n"  /* 0x0600FE98 */
    ".byte 0x06, 0x06, 0x38, 0x38, 0x00, 0x00, 0x90, 0x00, 0x06, 0x02, 0x84, 0x00, 0x06, 0x07, 0x88, 0x64\n"  /* 0x0600FEA8 */
    ".byte 0x06, 0x07, 0x88, 0x7F, 0x06, 0x05, 0xAC, 0xE4, 0x06, 0x02, 0x84, 0xAE, 0x25, 0xF0, 0x01, 0xE0\n"  /* 0x0600FEB8 */
    ".byte 0x06, 0x01, 0x1F, 0x1C, 0x25, 0xF0, 0x05, 0x20\n"  /* 0x0600FEC8 */
);
 ...
 * ================================================================ */
#if 0 /* FUN_06013C20 -- replaced by ASM import */
...
/* FUN_06013C20 -- original binary (56 bytes) */
__asm__(
    ".section .text.FUN_06013C20, \"ax\"\n"
    ".balign 2\n"
    ".global _FUN_06013C20\n"
    ".global _FUN_06013c20\n"
    ".type _FUN_06013C20, @function\n"
    "_FUN_06013C20:\n"
    "_FUN_06013c20:\n"
    ".byte 0x4F, 0x22, 0xE6, 0x14, 0xD5, 0x0B, 0x64, 0x51, 0x64, 0x4D, 0x74, 0x01, 0x34, 0x67, 0x8B, 0x01\n"  /* 0x06013C20 */
    ".byte 0xA0, 0x01, 0x63, 0x63, 0x63, 0x43, 0x63, 0x3D, 0x25, 0x31, 0xB1, 0xC3, 0x00, 0x09, 0xA2, 0x95\n"  /* 0x06013C30 */
    ".byte 0x4F, 0x26, 0xFF, 0xFF, 0x06, 0x08, 0x4B, 0x14, 0x06, 0x05, 0xB0, 0xFC, 0xAB, 0x11, 0x02, 0xFF\n"  /* 0x06013C40 */
    ".byte 0x06, 0x08, 0x4A, 0xF2, 0x06, 0x08, 0x4A, 0xF6\n"  /* 0x06013C50 */
);
 ...
 * ================================================================ */
#if 0 /* FUN_0600F794 -- replaced by ASM import */
...
/* FUN_0600F794 -- original binary (142 bytes) */
__asm__(
    ".section .text.FUN_0600F794, \"ax\"\n"
    ".balign 2\n"
    ".global _FUN_0600F794\n"
    ".global _FUN_0600f794\n"
    ".type _FUN_0600F794, @function\n"
    "_FUN_0600F794:\n"
    "_FUN_0600f794:\n"
    ".byte 0x2F, 0xE6, 0x4F, 0x22, 0x7F, 0xFC, 0xD3, 0x12, 0x2F, 0x32, 0x6E, 0x33, 0x7E, 0x02, 0xD3, 0x11\n"  /* 0x0600F794 */
    ".byte 0x6E, 0xE1, 0x43, 0x0B, 0xE4, 0x00, 0xD3, 0x10, 0x43, 0x0B, 0x00, 0x09, 0x60, 0xF2, 0x85, 0x03\n"  /* 0x0600F7A4 */
    ".byte 0x60, 0x0D, 0x88, 0x10, 0x8B, 0x1A, 0xB5, 0x3D, 0x00, 0x09, 0xA0, 0x19, 0x00, 0x09, 0x0B, 0x04\n"  /* 0x0600F7B4 */
    ".byte 0x0B, 0x38, 0x01, 0x70, 0x0C, 0x26, 0x04, 0xB0, 0x06, 0x06, 0x37, 0x50, 0x00, 0x00, 0x90, 0x00\n"  /* 0x0600F7C4 */
    ".byte 0x00, 0x00, 0xA0, 0x00, 0x06, 0x07, 0xEA, 0xDC, 0x06, 0x07, 0xEB, 0xCC, 0x06, 0x07, 0x88, 0x7F\n"  /* 0x0600F7D4 */
    ".byte 0x06, 0x06, 0x3D, 0x98, 0x06, 0x01, 0x14, 0xAC, 0x06, 0x01, 0x10, 0x94, 0xB5, 0x5A, 0x64, 0xE3\n"  /* 0x0600F7E4 */
    ".byte 0xB5, 0x79, 0x64, 0xE3, 0xD0, 0x14, 0x60, 0x00, 0x20, 0x08, 0x89, 0x0C, 0xD4, 0x13, 0x92, 0x21\n"  /* 0x0600F7F4 */
    ".byte 0x64, 0x41, 0x64, 0x4D, 0x24, 0x29, 0x24, 0x48, 0x89, 0x01, 0xA0, 0x01, 0xE3, 0x01, 0xE3, 0x00\n"  /* 0x0600F804 */
    ".byte 0x63, 0x3E, 0xD2, 0x0F, 0x22, 0x30, 0x7F, 0x04, 0x4F, 0x26, 0x00, 0x0B, 0x6E, 0xF6\n"  /* 0x0600F814 */
);
