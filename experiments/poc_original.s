 ...
 * Original bytes, no symbolization. Should produce identical bytes. */
...
_FUN_0600E71A:
    ...
    .byte 0xDE, 0x21  /* mov.l @(0x84,PC),r14 -> pool[0] = 0x0607E940 */
    .byte 0xD3, 0x22  /* mov.l @(0x88,PC),r3  -> pool[1] = 0x06008318 */
    .byte 0x43, 0x0B  /* jsr @r3 */
    .byte 0x6E, 0xE2  /* mov.l @r14,r14 */
    .byte 0xD3, 0x21  /* mov.l @(0x84,PC),r3  -> pool[2] = 0x06008640 */
    .byte 0x43, 0x0B  /* jsr @r3 */
    .byte 0x00, 0x09  /* nop */
    .byte 0xD3, 0x21  /* mov.l @(0x84,PC),r3  -> pool[3] = 0x0600D266 */
    .byte 0x43, 0x0B  /* jsr @r3 */
    .byte 0x00, 0x09  /* nop */
    .byte 0xD3, 0x20  /* mov.l @(0x80,PC),r3  -> pool[4] = 0x0600C4F8 */
    .byte 0x43, 0x0B  /* jsr @r3 */
    .byte 0x00, 0x09  /* nop */
    .byte 0xD3, 0x20  /* mov.l @(0x80,PC),r3  -> pool[5] = 0x0600C5D6 */
    .byte 0x43, 0x0B  /* jsr @r3 */
    .byte 0x00, 0x09  /* nop */
    ...
    .byte 0x0E, 0x36  /* mov.l r3,@(r0,r14) */
    .byte 0xD3, 0x11  /* mov.l @(0x44,PC),r3  -> pool[6] = 0x0600CEBA */
    .byte 0x43, 0x0B  /* jsr @r3 */
    .byte 0x00, 0x09  /* nop */
    .byte 0x90, 0x11  /* mov.w @(0x22,PC),r0 */
    .byte 0xD3, 0x10  /* mov.l @(0x40,PC),r3  -> pool[7] = 0x0607EA9C */
    .byte 0x02, 0xEE  /* mov.l @(r0,r14),r2 */
...
/* --- constant pool (32-bit, 4 bytes each) --- */
/* pool[0]: */ .byte 0x06, 0x07, 0xE9, 0x40  /* 0x0607E940 — DAT (car obj ptr) */
/* pool[1]: */ .byte 0x06, 0x00, 0x83, 0x18  /* 0x06008318 — FUN_06008318 */
/* pool[2]: */ .byte 0x06, 0x00, 0x86, 0x40  /* 0x06008640 — FUN_06008640 */
/* pool[3]: */ .byte 0x06, 0x00, 0xD2, 0x66  /* 0x0600D266 — FUN_0600D266 */
/* pool[4]: */ .byte 0x06, 0x00, 0xC4, 0xF8  /* 0x0600C4F8 — FUN_0600C4F8 */
/* pool[5]: */ .byte 0x06, 0x00, 0xC5, 0xD6  /* 0x0600C5D6 — FUN_0600C5D6 */
/* pool[6]: */ .byte 0x06, 0x00, 0xCE, 0xBA  /* 0x0600CEBA — FUN_0600CEBA */
/* pool[7]: */ .byte 0x06, 0x07, 0xEA, 0x9C  /* 0x0607EA9C — DAT (car count) */
