...
!
!   Enable check:
!     Reads 0x06086050 — if non-zero, sound is enabled
!     If disabled, branches to early return
!
...
! FUN_0601DB84 — Sound state prep (26 bytes, 13 insns, LEAF)
!   Quick lookup / state preparation before sound commands.
!   Called by dispatcher before writing to hardware.
...
! FUN_060302C6 — Sound initialization (470 bytes, 235 insns)
!   Initializes the SCSP sound system at boot.
!   Loads sound data files:
...
! | 0x06086050  |   4B | Sound enable flag          |
...
!   No handshaking or status polling — fire and forget.
